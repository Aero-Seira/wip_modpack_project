ItemEvents.modification(e => {
    ...
    modify("rimcraft:ethylene_fluid_bucket", 25000, "minecraft:bucket")
    modify("rimcraft:fuel_mixtures_bucket", 50000, "minecraft:bucket")
    ...
    modify('rimcraft:fuel_hotcream', 10000)
})
