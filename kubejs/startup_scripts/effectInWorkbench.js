...
if (Platform.isClientEnvironment())
    ClientEvents.init(event => {
        ...
        simpleRegWorkbenchBar('rimcraft:forstall', 5)
        simpleRegWorkbenchBar('rimcraft:overwhelm', 100)
        simpleRegWorkbenchBar('rimcraft:irradiation', 5)
        simpleRegWorkbenchBar('rimcraft:frozen', 30)
        simpleRegWorkbenchBar('rimcraft:ice_dragon_restraint', 30)
        simpleRegWorkbenchBar('rimcraft:fire_dragon_restraint', 30)
        simpleRegWorkbenchBar('rimcraft:lightning_dragon_restraint', 30)
        simpleRegWorkbenchBar('rimcraft:life_drain', 100)
        simpleRegWorkbenchBar('rimcraft:fiber_proliferation', 100)
        simpleRegWorkbenchBar('rimcraft:charge', 20)
