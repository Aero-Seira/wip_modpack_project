ItemEvents.modification(e => {
    ...
    maxStackSize_change('rimcraftcore:lush_confiture_jelly_bottle', 16)
    const iceCreamItems = [
    ...
    food_hungers("rimcraftcore:lush_confiture_jelly_bottle", 4, 3)
    food_hungers('rimcraft:fugu_roll', 10, 10)
    ...
    food_effects('rimcraft:fugu_roll', "farmersdelight:nourishment", 60)
    ...
    food_effects("rimcraftcore:lush_confiture_jelly_bottle", "cosmopolitan:tracer", 30)
    food_effects("rimcraftcore:lush_confiture_jelly_bottle", "cosmopolitan:phototaxis", 30)
    //紫颂果食物传送效果
    ...
    food_effects("rimcraft:chorus_cookie_dough", "fruitsdelight:chorus", 0.05)
    ...
    food_effects('rimcraft:empty_popsicle', "minecraft:fire_resistance", 10)
    ...
    green_tea_effect('rimcraft:green_tea_cookie_dough', 10, 0)
