StartupEvents.registry("block", e => {
    e.create("rimcraft:adzuki_beans", "crop")
        .age(6, age => {
        ...
        .dropSeed(true)
        .crop("rimcraft:adzuki_beans_seed", 1)
        ...
        .item(seed => {
            ...
            seed.translationKey("item.rimcraft.adzuki_beans_seed")
        })
        .renderType("cutout")
        .translationKey("block.rimcraft.adzuki_beans")
    e.create("rimcraft:artemisia_argyi", "crop")
        .age(3, age => {
            age.shape(0, 0, 0, 0, 16, 2, 16)
            age.shape(1, 0, 0, 0, 16, 4, 16)
            age.shape(2, 0, 0, 0, 16, 8, 16)
        ...
        .texture(0, "rimcraft:block/artemisia_argyi_stage0")
        .texture(1, "rimcraft:block/artemisia_argyi_stage1")
        .texture(2, "rimcraft:block/artemisia_argyi_stage2")
        .texture(3, "rimcraft:block/artemisia_argyi_stage3")
        .item(seed => {
            seed.texture("rimcraft:item/artemisia_argyi_seed")
            seed.translationKey("item.rimcraft.adzuki_beans_seed")
        })
        .renderType("cutout")
        .translationKey("block.rimcraft.artemisia_argyi")
