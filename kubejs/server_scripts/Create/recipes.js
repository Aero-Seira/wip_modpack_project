ServerEvents.recipes(e => {
    ...
    ).id("rimcraft:compacting/calcite")
    // 黑曜石粉末粉碎
    ...
    let iner_2 = "rimcraft:incomplete_electron_tube"
    ...
    {
        let iner = "rimcraft:incomplete_electron_tube"
    ...
    e.recipes.create_new_age.energising("create:electron_tube", "rimcraft:bleak_electron_tube", 10000)
    ...
    e.recipes.createmetallurgy.casting_in_basin(
        "create:andesite_casing",
        ["#forge:stripped_logs", Fluid.of("rimcraftcore:molten_andesite", 90)], 70, true)
    ...
    let andesiteOutputList = [
        ...
        e.recipes.vintageimprovements.pressurizing([
            ...
            [
                Fluid.of("rimcraftcore:molten_andesite", 450),
            ...
            .id(`rimcraft:pressurizing/${res.split(":")[1]}_from_nano_insectoid`)
    })
    let brassOutputList = [
    ...
    e.recipes.create.mixing(
        "create:pulp", 
        Fluid.of("rimcraft:paper_pulp", 250))
        .heated()
        .id("rimcraft:mixing/pulp")
    let stone_milling = [
