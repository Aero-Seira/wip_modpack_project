ServerEvents.recipes(e => {
    ...
    e.recipes.createmetallurgy.alloying(
        Fluid.of("rimcraftcore:molten_scarlet_neodymium", 90),
        [
            Fluid.of("createmetallurgy:molten_iron", 180),
            "alexscaves:raw_scarlet_neodymium",
            "alexscaves:raw_scarlet_neodymium"
        ]
    ).heatRequirement("superheated").id("rimcraft:alloying/molten_scarlet_neodymium")

    e.recipes.createmetallurgy.alloying(
        Fluid.of("rimcraftcore:molten_azure_neodymium", 90),
        [
            Fluid.of("createmetallurgy:molten_iron", 180),
            "alexscaves:raw_azure_neodymium",
            "alexscaves:raw_azure_neodymium"
        ]
    ).heatRequirement("superheated").id("rimcraft:alloying/molten_azure_neodymium")
    ...
    e.recipes.create.filling(
        ...
        [
            'minecraft:arrow',
            Fluid.of("rimcraftcore:molten_scarlet_neodymium", 10)
        ]
    ...
    e.recipes.create.mixing(
        ...
        [
            "minecraft:arrow",
            Fluid.of("rimcraftcore:molten_scarlet_neodymium", 20)
        ]
    ...
    //富铁粘液
    e.recipes.create.mixing(
        Fluid.of("rimcraftcore:ferrouslime", 90),
        [
            Fluid.of("rimcraftcore:slime", 90),
            '#forge:dusts/iron'
        ]
    ).id("alexscaves:mixing/ferrouslime")
    //紫颂黏液
    e.recipes.create.mixing(
        Fluid.of("rimcraftcore:chorusslime", 90),
        [
            Fluid.of("rimcraftcore:slime", 90),
            '#forge:chorus_fruits'
        ]
    ).id("rimcraft:mixing/chorusslime")
    ...
    e.recipes.create.mixing(
        Fluid.of("rimcraftcore:ferrouslime", 90),
        'alexscaves:ferrouslime_ball'
    ).heated().id("rimcraft:mixing/ferrouslime")
    //磁悬浮组件
    let iner_6 = "rimcraft:incomplete_magnetic_mechanism"
    e.recipes.create.sequenced_assembly('rimcraft:magnetic_mechanism', 'vintageimprovements:vanadium_sheet', [
            e.recipes.create.filling(iner_6, [iner_6, Fluid.of("rimcraftcore:ferrouslime", 90)]),
