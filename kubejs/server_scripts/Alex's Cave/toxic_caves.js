ServerEvents.recipes(e => {
  ...
  vintageimprovements
    .pressurizing(
      ...
      ["#rimcraft:fish_buckets", Fluid.of("alexscaves:acid", 1000)]
    )
    .heated()
    .id("rimcraft:radgill_bucket");

    //铀矿打粉
    e.recipes.create.crushing(
        [
            'rimcraft:uranium_dust',
            Item.of('rimcraft:uranium_dust').withChance(0.25)
        ],
        'alexscaves:uranium'
    ...
    e.recipes.vintageimprovements.pressurizing(
        [
            Fluid.of("rimcraft:light_crude_oil", 50),
            Fluid.of("rimcraft:ethylene_fluid", 20),
            'createmetallurgy:coke'
        ],
        Fluid.of("createdieselgenerators:crude_oil", 100), 60, 1
    )
        .superheated()
        .id("rimcraft:pyrolysis/crude_oil")
    //石油催化裂解
    e.recipes.vintageimprovements.pressurizing(
        [
            Fluid.of("rimcraft:light_crude_oil", 100),
            Fluid.of("rimcraft:ethylene_fluid", 50)
        ],
        [
        ...
        .superheated()
        .id("rimcraft:catalytic_cracking/crude_oil")
    //轻质油蒸馏
    e.recipes.createdieselgenerators.distillation(
        [
            Fluid.of("rimcraft:lubricating_oil", 20),
            Fluid.of("createdieselgenerators:diesel", 50),
            Fluid.of("createdieselgenerators:gasoline", 50),
            Fluid.of("rimcraft:ethylene_fluid", 20)
        ],
        Fluid.of("rimcraft:light_crude_oil", 100), 20
    )
        .heatRequirement("heated")
        .id("rimcraft:distillation/light_crude_oil")
    //乙烯乙醇互相制作
    e.recipes.vintageimprovements.pressurizing(
        ...
        [
            ...
            Fluid.water(250),
            Fluid.of("rimcraft:ethylene_fluid", 250)
        ]
    )
        .secondaryFluidInput(0)
        .heated()
        .id("rimcraft:pressurizing/ethanol_from_ethylene")
    e.recipes.vintageimprovements.pressurizing(
        [
            Fluid.of("rimcraft:ethylene_fluid", 250),
            Fluid.water(250)
        ...
        .heated()
        .id("rimcraft:pressurizing/ethylene_fluid_from_ethanol")
    //润滑油合成
    e.recipes.vintageimprovements.pressurizing(
       Fluid.of("rimcraft:lubricating_oil", 250), 
       [
    ...
    ).superheated().id("rimcraft:pressurizing/lubricating_oil")
    // 聚合物板
    e.recipes.vintageimprovements.pressurizing(
    ...
    e.recipes.create.crushing(
        [
            ...
            Item.of('rimcraft:carbon_dust').withChance(0.25)
        ],
        'createmetallurgy:graphite',
    ).id("rimcraft:crushing/carbon_dust")
    //石墨板合成
    ...
    ).id("rimcraft:filling/carbon_plate")
    e.recipes.vintageimprovements.pressurizing(
        "rimcraft:carbon_plate",
        [
            "rimcraft:carbon_dust",
            Fluid.of('rimcraft:ethylene_fluid', 10)
        ], 200
    )
        .heated()
        .id("rimcraft:pressurizing/carbon_plate")
    //核燃料棒合成
    {
        ...
        e.recipes.create.sequenced_assembly('create_new_age:nuclear_fuel', "ad_astra:steel_plate", [
            ...
            e.recipes.create.deploying(iner, [iner, 'rimcraft:carbon_plate']),
            e.recipes.create.deploying(iner, [iner, '#rimcraft:fisson_fuel']),
    ...
    e.recipes.kubejs.shapeless(
        ...
        '9x rimcraft:enriched_uraniumdust'
    ...
    [
        ...
        A: 'create:iron_sheet',
        B: 'rimcraft:bleak_electron_tube',
        C: 'rimcraft:enriched_uraniumdust'
    ...
    e.recipes.create.filling("alexscaves:radon_bottle", ["minecraft:glass_bottle", Fluid.of("rimcraft:radon").withAmount(250)])
        .id("alexscaves:filling/radon_bottle")
    e.recipes.create.emptying(["minecraft:glass_bottle", Fluid.of("rimcraft:radon").withAmount(250)], "alexscaves:radon_bottle")
