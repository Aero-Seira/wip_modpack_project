ServerEvents.tags("item", e => {
    ...
    e.add("rimcraft:fisson_fuel", [
        'rimcraft:enriched_uraniumdust',
        'create_new_age:radioactive_thorium'
    ])
    e.add("rimcraft:mint_candy", [
        'neapolitan:mint_candies',
        'alexscaves:frostmint'
    ])
    e.add("alexscaves:ice_cream_scoop", [
        'rimcraftcore:strawberry_ice_cream_scoop',
        'rimcraftcore:banana_ice_cream_scoop',
        'rimcraftcore:mint_ice_cream_scoop',
        'rimcraftcore:adzuki_ice_cream_scoop',
        'rimcraftcore:pomegranate_ice_cream_scoop',
        'rimcraftcore:lime_ice_cream_scoop',
    ])
    e.add("curios:belt", [
