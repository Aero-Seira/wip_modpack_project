ServerEvents.recipes((event) => {
  ...
  event.replaceInput({mod: "ae2omnicells"}, "ae2:quartz_glass", "#rimcraft:quartz_glass")
  ...
  function seq_1(input, output, a, b, c, d, e) {
    let iner = "rimcraft:incomplete_" + output.split(":")[1]
    create
      .sequenced_assembly(output, input, [
        ...
        vintageimprovements.curving(iner, iner).head("rimcraft:cell_housing_curving_head"),
      ])
      .loops(1)
  ...
  craft_shaped(i1k, "ae2:certus_quartz_crystal", "#rimcraft:quartz_glass", "#forge:dusts/redstone", "ae2:logic_processor")
  craft_shaped(i4k, i1k, "#rimcraft:quartz_glass", "#forge:dusts/redstone", "ae2:calculation_processor")
  craft_shaped(i16k, i4k, "#rimcraft:quartz_glass", "#forge:dusts/glowstone", "ae2:calculation_processor")
  craft_shaped(i64k, i16k, "#rimcraft:quartz_glass", "#forge:dusts/glowstone", "ae2:calculation_processor")
  craft_shaped(i256k, i64k, "#rimcraft:quartz_glass", "ae2:sky_dust", "ae2:calculation_processor")
  craft_shaped(i1m, i256k, "#rimcraft:quartz_vibrant_glass", "ae2:sky_dust", "megacells:accumulation_processor")
  craft_shaped(i4m, i1m, "#rimcraft:quartz_vibrant_glass", "#forge:dusts/ender_pearl", "megacells:accumulation_processor")
  craft_shaped(i16m, i4m, "#rimcraft:quartz_vibrant_glass", "#forge:dusts/ender_pearl", "megacells:accumulation_processor")
  craft_shaped(i64m, i16m, "#rimcraft:quartz_vibrant_glass", "ae2:matter_ball", "megacells:accumulation_processor")
  craft_shaped(i256m, i64m, "#rimcraft:quartz_vibrant_glass", "ae2:matter_ball", "megacells:accumulation_processor")
  ...
  create
    ...
    .id("rimcraft:mechanical_crafting_1k");
  create
    ...
    .id("rimcraft:mechanical_crafting_4k");
  create
    ...
    .id("rimcraft:mechanical_crafting_16k");
  create
    ...
    .id("rimcraft:mechanical_crafting_64k");
  create
    ...
    .id("rimcraft:mechanical_crafting_256k");
  create
    ...
    .id("rimcraft:mechanical_crafting_1m");
  create
    ...
    .id("rimcraft:mechanical_crafting_4m");
  create
    ...
    .id("rimcraft:mechanical_crafting_16m");
  create
    ...
    .id("rimcraft:mechanical_crafting_64m");
  create
    ...
    .id("rimcraft:mechanical_crafting_256m");
