ServerEvents.recipes((event) => {
  const { kubejs, vintageimprovements, create, minecraft, rimcraftcore } = event.recipes;

  // 石英玻璃部件
  vintageimprovements
    .curving("4x rimcraft:quartz_glass_parts", "ae2:quartz_glass")
    .head("rimcraft:cell_housing_curving_head")
    .id("rimcraft:quartz_glass_parts_curving");
  vintageimprovements
    .curving("4x rimcraft:quartz_vibrant_glass_parts", "ae2:quartz_vibrant_glass")
    .head("rimcraft:cell_housing_curving_head")
    .id("rimcraft:quartz_vibrant_glass_parts_curving");

  // 元件外壳封头
  kubejs
    .shapeless("rimcraft:cell_housing_curving_head", [
  ...
  vintageimprovements
    .pressurizing("rimcraft:mmd_diamond", coal_64)
    .superheated()
    .id("rimcraft:mmd_diamond_1");
  ...
  vintageimprovements
    .pressurizing("rimcraft:phase_transition_iron", iron_blocks_26)
    .id("rimcraft:phase_transition_iron_1");
  ...
  //       {
  //         type: "drop_item",
  //         item: "rimcraft:phase_transition_iron",
  //       },
  //     ],
  //   })
  //   .id("rimcraft:phase_transition_iron_2");
  ...
  .id("rimcraft:annihilation_core_2")
  let iner = "rimcraft:incomplete_annihilation_core"
  create.sequenced_assembly("ae2:annihilation_core", "ad_astra:steel_nugget", [
    ...
    .loops(1)
    .id("rimcraft:annihilation_core_1")
  ...
  .id("rimcraft:formation_core_2")
  let iner_2 = "rimcraft:incomplete_formation_core"
  create.sequenced_assembly("ae2:formation_core", "ad_astra:steel_nugget", [
    ...
    .loops(1)
    .id("rimcraft:formation_core_1")

  // 空间外壳
  kubejs.shaped("rimcraft:space_casing",
    [
      "ABA",
      "CDC",
      "ACA"
    ], {
    A: "rimcraft:phase_transition_iron",
    B: "ae2:singularity",
    C: "ae2:fluix_pearl",
  ...
  // 铁外壳
  minecraft.stonecutting("4x rimcraft:iron_casing", "#forge:storage_blocks/iron")

  // 陨钢外壳
  minecraft.stonecutting("4x rimcraft:sky_steel_casing", "#forge:storage_blocks/sky_steel")
  ...
  vintageimprovements.pressurizing(
    ...
    ]).id("rimcraft:accumulation_processor_press")
  ...
  .id("rimcraft:splashing/fluix_covered_dense_cable")
  create.splashing("ae2:fluix_smart_cable", Ingredient.of("#ae2:smart_cable").subtract("ae2:fluix_smart_cable"))
  .id("rimcraft:splashing/fluix_smart_cable")
  create.splashing("ae2:fluix_smart_dense_cable", Ingredient.of("#ae2:smart_dense_cable").subtract("ae2:fluix_smart_dense_cable"))
  .id("rimcraft:splashing/smart_dense_cable")

  rimcraftcore.fan_freezing("ae2:fluix_covered_cable", Ingredient.of("#ae2:covered_cable").subtract("ae2:fluix_covered_cable"))
  .id("rimcraft:fan_freezing/fluix_covered_cable")
  rimcraftcore.fan_freezing("ae2:fluix_glass_cable", Ingredient.of("#ae2:glass_cable").subtract("ae2:fluix_glass_cable"))
  .id("rimcraft:fan_freezing/fluix_glass_cable")
  rimcraftcore.fan_freezing("ae2:fluix_covered_dense_cable", Ingredient.of("#ae2:covered_dense_cable").subtract("ae2:fluix_covered_dense_cable"))
  .id("rimcraft:fan_freezing/fluix_covered_dense_cable")
  rimcraftcore.fan_freezing("ae2:fluix_smart_cable", Ingredient.of("#ae2:smart_cable").subtract("ae2:fluix_smart_cable"))
  .id("rimcraft:fan_freezing/fluix_smart_cable")
  rimcraftcore.fan_freezing("ae2:fluix_smart_dense_cable", Ingredient.of("#ae2:smart_dense_cable").subtract("ae2:fluix_smart_dense_cable"))
  .id("rimcraft:fan_freezing/smart_dense_cable")
