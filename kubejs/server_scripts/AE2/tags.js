...
ServerEvents.tags("item", (e) => {
  ...
  e.add("rimcraft:quartz_glass", "ae2:quartz_glass");
  e.add("rimcraft:quartz_vibrant_glass", "ae2:quartz_vibrant_glass");
  e.add("rimcraft:glowstone", "minecraft:glowstone_dust");
  e.add("rimcraft:sky_stone", "ae2:sky_dust");
  e.add("rimcraft:redstone", "minecraft:redstone");
});
...
ServerEvents.tags("fluid", e => {
  e.add("rimcraft:spent_liquor", "rimcraft:spent_liquor")
})