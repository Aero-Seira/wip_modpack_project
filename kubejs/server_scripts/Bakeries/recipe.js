...
ServerEvents.recipes(e => {
    ...
    e.replaceInput({}, "bakeries:cake_paste_bucket", "rimcraft:cake_batter_bucket")
    create.mixing("4x bakeries:honey_butter", [FluidIngredients("forge:honey", 250), "2x rimcraft:butter"])
    ...
    vintageimprovements.vacuumizing(
        ...
        .id("rimcraft:vacuumizing/dry_yeast")
    create.mixing(
        Fluid.of("rimcraft:yeast", 250),
        [
            Fluid.water(200),
    ...
    ).id("rimcraft:mixing/yeast_fluid")
    create.filling(
    ...
    fermenting(e,
        ...
        ["rimcraft:dry_yeast"]
            .concat(multi_item("bakeries:flour", 5))
            .concat(Fluid.of("rimcraft:egg_yolk", 250)),
        400
    )
    fermenting(e,
        "5x farmersdelight:wheat_dough",
        ["rimcraft:dry_yeast"]
            .concat(multi_item("bakeries:flour", 5))
            .concat(Fluid.of("rimcraft:artificial_egg_yolk", 250)),
        400
    )
    fermenting(e,
    ...
    createaddition.rolling("rimcraft:puff_pastry", "bakeries:croissant_dough").id("bakeries:rolling/croissant_dough")
    ...
    ).id("bakeries:pineapple_bun_dough_manual_only")
    {
        ...
        create.sequenced_assembly('bakeries:pineapple_bun_dough', 'bakeries:round_bread_dough',
            [
                create.deploying(iner, [iner, 'rimcraft:butter']),
    ...
    vintageimprovements.vacuumizing(
        ...
        Fluid.of("rimcraft:unrefined_sugar", 200)
    )
        .secondaryFluidOutput(0)
        .heated()
    ...
    create.filling("bakeries:paper_cup_cake_paste", ["bakeries:paper_cup", Fluid.of("rimcraft:cake_batter", 250)])
    ...
    create.filling("bakeries:soak_coffee_cut_cake_base", ["bakeries:cut_cake_base", Fluid.of("rimcraft:espresso_fluid", 250)])
    ...
    // create.filling("bakeries:crispy_dough", ["rimcraft:oil_dough", FluidIngredients("forge:milk", 250)])
    //     .id("bakeries:filling/crispy_dough")
    create.cutting("8x bakeries:scone_dough", 'rimcraft:puff_pastry')
    ...
    }).id("bakeries:dough_crafting_table/scone_dough")
    {
        ...
        create.sequenced_assembly("bakeries:mould_pound_cake_paste", "bakeries:mould", [
            create.filling(iner, [iner, Fluid.of("rimcraft:cake_batter", 500)]),
