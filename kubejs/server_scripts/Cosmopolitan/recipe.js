ServerEvents.recipes(e => {
    ...
    create.mixing("cosmopolitan:gulime", [
        Fluid.of("rimcraftcore:slime", 270),
    ...
    create.mixing(Fluid.of("cosmopolitan:berry_syrup", 250), [
        "4x #forge:berries",
        Fluid.of("rimcraft:base_syrup", 500)
    ...
    create.mixing(
        Fluid.of("rimcraft:lush_confiture_jelly", 125),
        [
            Fluid.of("water", 100),
            "minecraft:sugar",
    ...
    create.filling('rimcraftcore:lush_confiture_jelly_bottle', [Fluid.of("rimcraft:lush_confiture_jelly", 125), "minecraft:glass_bottle"]).id("cosmopolitan:filling/lush_confiture_jelly_bottle")
    create.emptying([Fluid.of("rimcraft:lush_confiture_jelly", 125), "minecraft:glass_bottle"], 'rimcraftcore:lush_confiture_jelly_bottle').id("cosmopolitan:emptying/lush_confiture_jelly_bottle")
    create.filling('rimcraft:lush_confiture_jello_item', [Fluid.of("rimcraft:lush_confiture_jello", 125), "minecraft:bowl"]).id("cosmopolitan:filling/lush_confiture_jello_item")
    ...
    kubejs.shapeless(
        'rimcraftcore:lush_confiture_jelly',
        '8x rimcraftcore:lush_confiture_jelly_bottle'
    ).replaceIngredient("rimcraftcore:lush_confiture_jelly_bottle", "minecraft:glass_bottle").id("rimcraftcore:lush_confiture_jelly_block_manual_only")
    kubejs.shapeless(
        '8x rimcraftcore:lush_confiture_jelly_bottle',
        [
            'rimcraftcore:lush_confiture_jelly',
    ...
    ).id("rimcraftcore:lush_confiture_jelly_manual_only")
    create.compacting(
        'rimcraftcore:lush_confiture_jelly',
        Fluid.of("rimcraft:lush_confiture_jelly", 1000)
    ).id("cosmopolitan:compacting/lush_confiture_jelly")
    kubejs.shapeless(
        'rimcraftcore:lush_confiture_jello',
        '8x rimcraft:lush_confiture_jello_item'
    ).replaceIngredient("rimcraft:lush_confiture_jello_item", "minecraft:bowl").id("rimcraftcore:lush_confiture_jello_block_manual_only")
    kubejs.shapeless(
        '8x rimcraft:lush_confiture_jello_item',
        [
            'rimcraftcore:lush_confiture_jello',
    ...
    ).id("rimcraftcore:lush_confiture_jello_manual_only")
    create.compacting(
        'rimcraftcore:lush_confiture_jello',
        Fluid.of("rimcraft:lush_confiture_jello", 1000)
    ).id("cosmopolitan:compacting/lush_confiture_jello")
    create.mixing(
        Fluid.of("rimcraft:lush_confiture_jello", 125),
        [
            '#forge:gelatin',
            Fluid.of("rimcraft:lush_confiture_jelly", 125)
        ]
    ...
    create.mixing(
        Fluid.of("rimcraft:spring_soda", 250),
        [
    ...
    create.filling("cosmopolitan:spring_soda", [Fluid.of("rimcraft:spring_soda", 250), "minecraft:glass_bottle"]).id("cosmopolitan:filling/spring_soda")
    create.emptying([Fluid.of("rimcraft:spring_soda", 250), "minecraft:glass_bottle"], 'cosmopolitan:spring_soda').id("cosmopolitan:emptying/spring_soda")
    create.mixing(
        Fluid.of("rimcraft:summer_cordial", 250),
        [
    ...
    create.filling("cosmopolitan:summer_cordial", [Fluid.of("rimcraft:summer_cordial", 250), "minecraft:glass_bottle"]).id("cosmopolitan:filling/summer_cordial")
    create.emptying([Fluid.of("rimcraft:summer_cordial", 250), "minecraft:glass_bottle"], 'cosmopolitan:summer_cordial').id("cosmopolitan:emptying/summer_cordial")
    create.mixing(
        Fluid.of("rimcraft:autumn_tea", 250),
        [
            Fluid.of("create:honey", 250),
            "2x #forge:flour",
    ...
    create.filling("cosmopolitan:autumn_tea", [Fluid.of("rimcraft:autumn_tea", 250), "minecraft:glass_bottle"]).id("cosmopolitan:filling/autumn_tea")
    create.emptying([Fluid.of("rimcraft:autumn_tea", 250), "minecraft:glass_bottle"], 'cosmopolitan:autumn_tea').id("cosmopolitan:emptying/autumn_tea")
    create.mixing(
        Fluid.of("rimcraft:winter_glogg", 250),
        [
            Fluid.of("cosmopolitan:birch_sap", 250),
    ...
    create.filling("cosmopolitan:winter_glogg", [Fluid.of("rimcraft:winter_glogg", 250), "minecraft:glass_bottle"]).id("cosmopolitan:filling/winter_glogg")
    create.emptying([Fluid.of("rimcraft:winter_glogg", 250), "minecraft:glass_bottle"], 'cosmopolitan:winter_glogg').id("cosmopolitan:emptying/winter_glogg")
    {
        let iner = 'cosmopolitan:arbutus_berries'
        create.sequenced_assembly("rimcraft:enchanted_golden_arbutus_berries", 'cosmopolitan:arbutus_berries', [
            ...
            .loops(4)
            .transitionalItem(iner)
            .id("rimcraft:enchanted_golden_arbutus_berries")
    }
    create.filling(
    ...
    create.filling(
        ...
        [
            ...
            Fluid.of("rimcraft:lush_confiture_jelly", 50)
        ]
    ...
    create.pressing(
        ...
        'minecraft:potato'
    ).id("rimcraft:pressing/raw_potato_pancake")
    kubejs.shapeless(
    ...
    baking(e, 'rimcraft:wafer_dough', 'cosmopolitan:wafer', 1.0, "food", 100)
    farmersdelight.cooking(
        [
            '#fruitsdelight:jello',
            "minecraft:sugar",
