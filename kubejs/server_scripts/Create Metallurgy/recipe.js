ServerEvents.recipes(e => {
    ...
    metal_production_line_5(e, [
        ...
        "rimcraftcore:raw_tin",
        "rimcraftcore:tin_nugget"])
    metal_production_line_5(e, [
    ...
    e.recipes.create.mixing(
        Fluid.of("rimcraftcore:molten_andesite", 270),
        [
            "minecraft:andesite",
    ...
    entity_melting(e, Fluid.of("rimcraft:fire_dragon_blood", 5000), "iceandfire:fire_dragon", 4)
        .id("createmetallurgy:entity_melting/fire_dragon")
    entity_melting(e, Fluid.of("rimcraft:ice_dragon_blood", 5000), "iceandfire:ice_dragon", 4)
        .id("createmetallurgy:entity_melting/ice_dragon")
    entity_melting(e, Fluid.of("rimcraft:lightning_dragon_blood", 5000), "iceandfire:lightning_dragon", 4)
