ItemEvents.rightClicked("rimcraft:debug_reload_tool", e => {
...
ItemEvents.rightClicked("rimcraft:debug_info_tool", e => {
...
BlockEvents.rightClicked(e => {
  ...
  if(player.mainHandItem.id == "rimcraft:debug_info_tool"){
