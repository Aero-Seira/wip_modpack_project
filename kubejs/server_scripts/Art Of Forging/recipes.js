ServerEvents.recipes(e => {
    ...
    kubejs.shaped(
        ...
        ],
        {
            ...
            C: "rimcraft:otherworld_note",
            D: "minecraft:beacon"
        }
    )
        .id("tetra:crucible_scroll")

    e.replaceInput({ mod: "tetra" }, "minecraft:writable_book", "rimcraft:otherworld_note")
    e.replaceInput([{ id: "art_of_forging:forged_platform" }, { id: "art_of_forging:forged_pillar" }], "art_of_forging:forged_steel_ingot", "rimcraft:forged_steel_sheet")
    ...
    kubejs.shaped(
        ...
        ["", "#tetra:swords", ""],
        ["#forge:plates/iron", "rimcraft:otherworld_note", "#forge:rods/iron"],
        ["", "#forge:ingots/iron", ""]
    ])
    ...
    metal_production_line_3(e,
        ["rimcraftcore:forged_steel_block", "art_of_forging:forged_steel_ingot", "rimcraft:forged_steel_sheet", "rimcraftcore:molten_forged_steel"], "superheated", 160)
    kubejs.shapeless("rimcraftcore:forged_steel_block", "9x art_of_forging:forged_steel_ingot")
        .id("art_of_forging:forged_steel_ingot_from_forged_steel_block")
    kubejs.shapeless("9x art_of_forging:forged_steel_ingot", "rimcraftcore:forged_steel_block")
        .id("art_of_forging:forged_steel_block")
    createmetallurgy.alloying(Fluid.of("rimcraftcore:molten_forged_steel", 360), [
        "tetra:metal_scrap",
        "tetra:metal_scrap",
        "tetra:metal_scrap",
        "tetra:metal_scrap",
        Fluid.of("rimcraft:spent_liquor", 250),
        Fluid.of("createmetallurgy:molten_netherite", 30)
    ])
        .heatRequirement("superheated")
        .id("art_of_forging:alloying/molten_forged_steel")
    create.pressing("rimcraft:forged_steel_sheet", "art_of_forging:forged_steel_ingot")
        .id("art_of_forging:pressing/forged_steel_sheet")
    {
        ...
        create.sequenced_assembly("dreadsteel:dreadsteel_ingot", "art_of_forging:forged_steel_ingot", [
            ...
            create.filling(iner, [iner, Fluid.of("rimcraftcore:molten_fire_steel", 90)]),
            create.deploying(iner, [iner, "art_of_forging:fragment_of_eden"]),
            create.filling(iner, [iner, Fluid.of("rimcraftcore:molten_ice_steel", 90)]),
            create.deploying(iner, [iner, "rimcraft:dread_heart"]),
            create.filling(iner, [iner, Fluid.of("rimcraftcore:molten_lightning_steel", 90)])
        ])
            .loops(1)
    ...
    vintageimprovements.vacuumizing(Fluid.of("rimcraft:malice_solution", 1000), [
...

    {
        ...
        create.sequenced_assembly("art_of_forging:demonic_blade", "art_of_forging:ancient_blade", [
            ...
            create.deploying(iner, [iner, "art_of_forging:fragment_of_eden"]),
            create.filling(iner, [iner, Fluid.of("rimcraft:malice_solution", 1000)]),
            vintageimprovements.hammering(iner, iner)
        ])
            .loops(1)
            .transitionalItem(iner)
    ...
    }
    {
        ...
        create.sequenced_assembly("art_of_forging:sigil_of_eden", "art_of_forging:shards_of_malice", [
            ...
            create.deploying(iner, [iner, "art_of_forging:fragment_of_eden"]),
            create.filling(iner, [iner, Fluid.of("rimcraft:malice_solution", 250)]),
    ...
    }
    {
        ...
        create.sequenced_assembly("vvaddon:mine_ingot", "createaddition:electrum_ingot", [
            ...
            create.deploying(iner, [iner, "rimcraft:bleak_electron_tube"]),
            create.deploying(iner, [iner, "createaddition:capacitor"]),
            create_new_age.energising(iner, iner, 100000),
            create.filling(iner, [iner, Fluid.of("rimcraft:sky_solution", 1000)])
        ])
            .loops(1)
            .transitionalItem(iner)
    ...
    {
        let iner = "rimcraft:forged_steel_sheet"
        create.sequenced_assembly("art_of_forging:encoded_canister", iner, [
            ...
            create.deploying(iner, [iner, "rimcraft:forged_steel_sheet"]),
            create.pressing(iner, iner)
        ])
            .loops(1)
            .transitionalItem(iner)
