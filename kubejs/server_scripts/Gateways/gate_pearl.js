ServerEvents.recipes(e => {
    //增加配方：冰龙试炼珍珠合成
    e.shaped(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:ice_dragon"}'), [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    //增加配方：火龙试炼珍珠合成
    e.shaped(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:fire_dragon_eyes"}'), [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    //增加配方：雷龙试炼珍珠合成
    e.shaped(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:lightning_dragon"}'), [
        "ABA",
        "CDC",
        "ABA"
    ], {
    ...
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:the_gate_of_eternal_cold"}'))
        ...
        create.filling(incomplete, [incomplete, Fluid.of("rimcraft:ice_dragon_blood", 250)]),
        create.deploying(incomplete, [incomplete, "rimcraft:dread_heart"])
    ]).transitionalItem(incomplete).loops(4)
    .id("rimcraft:sequenced_assembly/the_gate_of_eternal_cold")
    //添加配方：枯萎穿刺试炼合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:piercing_withering_trial"}'))
    ], "minecraft:ender_pearl", [
        ...
        create.deploying(incomplete, [incomplete, "rimcraft:otherworld_note"])
    ]).transitionalItem(incomplete).loops(4)
    .id("rimcraft:sequenced_assembly/piercing_withering_trial")
    //添加恶魂试炼
    e.shaped(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:ghast_trial"}'), [
        "AAA",
        "ABA",
        "AAA"
    ], {
    ...
    //添加配方：糖分临界点合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:sweettide_brokenpoint"}'))
    ], "minecraft:ender_pearl", [
    ...
    .id("rimcraft:sequenced_assembly/sweettide_brokenpoint")
    ////添加配方：黯渊之视合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:infinite_and_dark_trials"}'))
    ], "minecraft:ender_pearl", [
        create.deploying(incomplete, [incomplete, "alexscaves:pure_darkness"]),
        create.cutting(incomplete, incomplete),
        vintageimprovements.vibrating(incomplete, incomplete),
        create.deploying(incomplete, [incomplete, "rimcraft:devil_eye"]),
    ...
    .id("rimcraft:sequenced_assembly/infinite_and_dark_trials")
    ////添加配方：磁暴领域合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:magnetic_storm_field"}'))
    ], "minecraft:ender_pearl", [
    ...
    .id("rimcraft:sequenced_assembly/magnetic_storm_field")
    ////添加配方：熔蚀之地合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:a_place_of_melting"}'))
    ], "minecraft:ender_pearl", [
    ...
    .id("rimcraft:sequenced_assembly/a_place_of_melting")
    ////添加配方：远古终焉合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:the_ancient_end"}'))
    ], "minecraft:ender_pearl", [
    ...
    .id("rimcraft:sequenced_assembly/the_ancient_end")
    ////添加配方：自噬之潮合成
    create.sequenced_assembly([
        Item.of(Item.of('gateways:gate_pearl', '{gateway:"rimcraft:the_legacy_of_the_abyss"}'))
    ], "minecraft:ender_pearl", [
    ...
    .id("rimcraft:sequenced_assembly/the_legacy_of_the_abyss")
})
