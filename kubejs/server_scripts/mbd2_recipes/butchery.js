ServerEvents.recipes(e => {
    ...
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/black_rabbit")
    //屠宰棕兔
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/brown_rabbit")
    //屠宰斑点兔
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/splotched_rabbit")
    //屠宰金兔
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/gold_rabbit")
    //屠宰盐腌兔
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/salt_rabbit")
    //屠宰白兔
    e.recipes.rimcraft.butchery()
        ...
        .outputFluids(Fluid.of("butchercraft:blood_fluid", 500))
        .id("rimcraft:butcher/white_rabbit")
    //屠宰牛头
    e.recipes.rimcraft.butchery()
    ...
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/sheep_head")
    //屠宰猪头
    e.recipes.rimcraft.butchery()
    ...
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/chicken_head")
    //屠宰棕兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_brown_head")
    //屠宰金兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_gold_head")
    //屠宰盐腌兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_salt_head")
    //屠宰斑点兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_splotched_head")
    //屠宰白兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_white_head")
    //屠宰黑兔头
    e.recipes.rimcraft.butchery()
        ...
        .id("rimcraft:butcher/rabbit_black_head")
})