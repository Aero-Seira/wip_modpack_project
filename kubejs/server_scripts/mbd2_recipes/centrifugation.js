...
ServerEvents.recipes(e => {
  e.forEachRecipe(
    ...
    if (newIngr.length > 1 || hasFluid)
      return
    e.recipes.rimcraft.small_centrifugation()
  ...
  e.recipes.rimcraft.big_centrifugation()
    ...
    .id("rimcraft:big_centrifugation/unrefined_waste")
  e.recipes.rimcraft.big_centrifugation()
    .inputItems('rimcraft:uranium_dust')
    .duration(1000)
    .chance(0.1, builder => builder
      .outputItems('rimcraft:enriched_uraniumdust')
    )
    .chance(0.9, builder => builder
     .outputItems("rimcraft:depleted_uranium_dust")
    )
    .id("rimcraft:big_centrifugation/uranium_dust")
    //液体离心
    //双液体组分液体离心
    ...
    fluidSeparation_2_fluids.forEach(fluid => {
      e.recipes.rimcraft.big_centrifugation()
        ...
        .duration(100)
        .id(`rimcraft:big_centrifugation/separation/${fluid[0][0].split(":")[1]}`)
    })
  //液固混合液体离心
  e.recipes.rimcraft.big_centrifugation()
    .inputFluids(Fluid.of("rimcraftcore:ferrouslime", 900))
    .outputFluids(Fluid.of("rimcraftcore:slime", 900))
    .id("rimcraft:big_centrifugation/separation/ferrouslime")
  //巧克力离心
  e.recipes.rimcraft.big_centrifugation()
    ...
    .id("rimcraft:big_centrifugation/separation/chocolate")
  e.recipes.rimcraft.big_centrifugation()
    ...
    .id("rimcraft:big_centrifugation/separation/ruby_chocolate")
  e.recipes.rimcraft.big_centrifugation()
    .inputFluids(Fluid.of("create_confectionery:white_chocolate", 250))
    .outputItems("ratatouille:cocoa_butter")
    .outputItems("minecraft:sugar")
    .outputFluids(Fluid.of("minecraft:milk", 250))
    .id("rimcraft:big_centrifugation/separation/white_chocolate")
  e.recipes.rimcraft.big_centrifugation()
    .inputFluids(Fluid.of("create_confectionery:black_chocolate", 250))
    .outputItems("ratatouille:cocoa_butter")
    .outputItems("ratatouille:cocoa_solids")
    .outputFluids(Fluid.of("minecraft:milk", 250))
    .id("rimcraft:big_centrifugation/separation/black_chocolate")
})