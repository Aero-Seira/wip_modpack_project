ServerEvents.recipes(e => {
    ...
    e.recipes.kubejs.shaped(
        ...
        A: "rimcraftcore:iron_coin",
        B: "rimcraftcore:gold_coin"
    }
...
MoreJSEvents.villagerTrades(e => {
    ...
    const trades = [
        ["5x rimcraftcore:iron_coin", "lightmanscurrency:cash_register"],
        ["rimcraftcore:copper_coin", "lightmanscurrency:terminal"],
        ["8x rimcraftcore:iron_coin", "lightmanscurrency:atm"],
        ["rimcraftcore:copper_coin", 'lightmanscurrency:portable_gem_terminal'],
        ["8x rimcraftcore:iron_coin", 'lightmanscurrency:portable_atm'],
        ["4x rimcraftcore:iron_coin", "8x rimcraftcore:iron_coin", "lightmanscurrency:trading_core"]
    ]
