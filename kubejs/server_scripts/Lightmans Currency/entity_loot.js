...
EntityEvents.drops(e => {
    ...
    if (entity instanceof $Mob) {
        ...
        if (itemStack.item instanceof $ModularItem && TetraUtil.itemHasEffect(itemStack, "rimcraft:greedy")) {
            let level = TetraUtil.getEffectLevel(itemStack, "rimcraft:greedy")
