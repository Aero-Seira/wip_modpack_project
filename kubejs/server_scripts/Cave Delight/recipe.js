ServerEvents.recipes(e => {
    ...
    brewing(e, 'farmersrespite:green_tea', ['alexscaves:fiddlehead', 'alexscaves:fiddlehead'], 'rimcraft:fiddlehead_tea', 'cavedelight:fiddlehead_tea')
    e.recipes.create.mixing(
        Fluid.of("rimcraft:fiddlehead_tea", 500),
        [
    ...
    e.recipes.create.filling(
        "cavedelight:fiddlehead_tea",
        [
            Fluid.of("rimcraft:fiddlehead_tea", 250),
