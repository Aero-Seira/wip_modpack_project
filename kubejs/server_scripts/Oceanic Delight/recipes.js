ServerEvents.recipes(e => {
    ...
    e.replaceInput({id: "oceanic_delight:fish_egg_noodle_soup"}, "#forge:pasta", 'rimcraft:vermicelli')
    // 河豚水饺
    dumpling(e, [
    ...
    // 鱿鱼须相关
    cutting_2(e, "oceanic_delight:squid_tentacles", [["rimcraft:raw_calamari", 3]])
    cutting_2(e, "oceanic_delight:glow_squid_tentacles", [["rimcraft:raw_calamari", 3]])
    ...
    ).id("rimcraft:mixing/salmon_eggs")
})
