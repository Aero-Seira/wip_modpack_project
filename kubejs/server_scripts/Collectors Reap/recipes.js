ServerEvents.recipes(e => {
    ...
    e.replaceInput({id: "collectorsreap:food/buttered_legs"}, "#forge:milk", "rimcraft:butter")
    e.replaceInput({}, "collectorsreap:cooked_tiger_prawn", "#forge:shrimps")
    e.replaceInput({id: "collectorsreap:food/prawn_noodles"}, "#forge:pasta", 'rimcraft:vermicelli')
    ...
    create.mixing(
        ...
        .id("rimcraft:mixing/berry_limeade")
    create.mixing(
        Fluid.of("create_central_kitchen:berry_limeade", 500),
        [
            "#forge:berries", 
        ...
        .id("rimcraft:mixing/berry_limeade_2")
    create.emptying(
        [
        ...
        .id("rimcraft:emptying/berry_limeade")
    create.filling(
        "collectorsreap:berry_limeade", 
        [
            Fluid.of("create_central_kitchen:berry_limeade", 250),
    ...
    create.mixing(
        ...
        .id("rimcraft:mixing/pink_limeade")
    create.mixing(
        Fluid.of("create_central_kitchen:pink_limeade", 500),
        [
            "#forge:fruits/pomegranate",
        ...
        .id("rimcraft:mixing/pink_limeade_2")
    create.emptying(
        [
        ...
        .id("rimcraft:emptying/pink_limeade")
    create.filling(
        "collectorsreap:pink_limeade",
        [
            Fluid.of("create_central_kitchen:pink_limeade", 250),
    ...
    create.mixing(
        ...
        .id("rimcraft:mixing/mint_limeade")
    create.mixing(
        Fluid.of("create_central_kitchen:mint_limeade", 500),
        [
            "#neapolitan:mint_leaves",
        ...
        .id("rimcraft:mixing/mint_limeade_2")
    create.emptying(
        [
        ...
        .id("rimcraft:emptying/mint_limeade")
    create.filling(
        "collectorsreap:mint_limeade",
        [
            Fluid.of("create_central_kitchen:mint_limeade", 250),
