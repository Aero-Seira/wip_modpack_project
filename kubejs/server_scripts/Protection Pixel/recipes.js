ServerEvents.recipes(e => {
    ...
    let iner_2 = "rimcraft:incomplete_fire_dragonsteel_armorplate"
    e.recipes.create.sequenced_assembly(Item.of('rimcraft:fire_dragonsteel_armorplate', '{Damage:0,armor:2.5d,toughness:1.5d,weight:1.5d}'), "protection_pixel:alloyarmorplate", [
        e.recipes.create.filling(iner_2, [iner_2, Fluid.of("rimcraft:fire_dragon_blood", 1000)]),
    ...
    .id("rimcraft:sequenced_assembly/fire_dragonsteel_armorplate")

    let iner_3 = "rimcraft:incomplete_ice_dragonsteel_armorplate"
    e.recipes.create.sequenced_assembly(Item.of('rimcraft:ice_dragonsteel_armorplate', '{Damage:0,armor:2.5d,toughness:1.5d,weight:1.5d}'), "protection_pixel:alloyarmorplate", [
        e.recipes.create.filling(iner_3, [iner_3, Fluid.of("rimcraft:ice_dragon_blood", 1000)]),
    ...
    .id("rimcraft:sequenced_assembly/ice_dragonsteel_armorplate")

    let iner_4 = "rimcraft:incomplete_lightning_dragonsteel_armorplate"
    e.recipes.create.sequenced_assembly(Item.of('rimcraft:lightning_dragonsteel_armorplate', '{Damage:0,armor:2.5d,toughness:1.5d,weight:1.5d}'), "protection_pixel:alloyarmorplate", [
        e.recipes.create.filling(iner_4, [iner_4, Fluid.of("rimcraft:lightning_dragon_blood", 1000)]),
    ...
    .id("rimcraft:sequenced_assembly/lightning_dragonsteel_armorplate")
})
