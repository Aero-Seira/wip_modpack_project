...
const armorplate = {
    "rimcraft:fire_dragonsteel_armorplate": [2.5, 1.5, 1.5],
    "rimcraft:ice_dragonsteel_armorplate": [2.5, 1.5, 1.5],
    "rimcraft:lightning_dragonsteel_armorplate": [2.5, 1.5, 1.5]
}
    ...
    entity.getArmorSlots().forEach(item => {
        ...
        if (item.hasTag("protection_pixel:protection")) {
            ...
            while (true) {
                ...
                if (id == null)
                    break
                if (id == "rimcraft:fire_dragonsteel_armorplate") {
                    fire_count++
                    dragonsteel_count++
                }
                if (id == "rimcraft:ice_dragonsteel_armorplate") {
                    ice_count++
                    dragonsteel_count++
                }
                if (id == "rimcraft:lightning_dragonsteel_armorplate") {
                    lightning_count++
                    dragonsteel_count++
                }
                slot_count++
