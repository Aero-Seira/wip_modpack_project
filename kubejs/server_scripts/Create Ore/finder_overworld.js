...
ItemEvents.rightClicked("rimcraft:prospector", e => {
    ...
    let message = Component.translate("message.rimcraft.nearest_vein")
                .append(info.getName().color(Color.YELLOW))
    if (direction == 'Same Point') {
        message = message
        .append(Component.translate("message.rimcraft.underfoot"))
    } else {
        message = message
        .append(Component.translate("message.rimcraft.at", direction, distance))
    }
    player.swing()
