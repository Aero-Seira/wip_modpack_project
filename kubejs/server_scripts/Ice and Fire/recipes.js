ServerEvents.recipes(e => {
    ...
    create.filling("ends_delight:raw_dragon_meat", ["#rimcraft:dragon_flesh", Fluid.of("create_central_kitchen:dragon_breath", 250)])
    ...
    armor.forEach(item => {
        ...
        minecraft.smithing_transform(res, "rimcraft:dread_upgrade_smithing_template", item, "dreadsteel:dreadsteel_ingot")
    ...
    kubejs.shaped("2x rimcraft:dread_upgrade_smithing_template", [
        "ABA",
        "ACA",
        "AAA"
    ], {
        A: ['iceandfire:dragonsteel_fire_ingot', 'iceandfire:dragonsteel_ice_ingot', 'iceandfire:dragonsteel_lightning_ingot'],
        B: "rimcraft:dread_heart",
        C: "rimcraft:dread_upgrade_smithing_template"
    }).id("rimcraft:dread_upgrade_smithing_template")
