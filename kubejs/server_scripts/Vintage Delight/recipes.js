ServerEvents.recipes(e => {
    ...
    e.replaceInput({id: "vintagedelight:cooking/pad_thai"}, "#forge:pasta", 'rimcraft:vermicelli')
    ...
    e.recipes.create.emptying(
        [
            Fluid.of("rimcraft:nut_milk", 250),
    ...
    ).id("vintagedelight:nut_milk_bottle").replaceIngredient("rimcraft:nut_milk_bucket", "minecraft:bucket")
    e.recipes.create.mixing(
        Fluid.of("rimcraft:nut_milk", 250),
        [
    ...
    e.recipes.create.filling("vintagedelight:vinegar_bottle", ["minecraft:glass_bottle", Fluid.of("rimcraft:vinegar", 250)])
    .id("create:filling/compat/vintagedelight/vinegar_bottle")
    e.recipes.create.filling("vintagedelight:vinegar_mason_jar", ["vintagedelight:mason_jar", Fluid.of("rimcraft:vinegar", 750)])
    .id("create:filling/compat/vintagedelight/vinegar_jar")
    e.recipes.create.emptying(["minecraft:glass_bottle", Fluid.of("rimcraft:vinegar", 250)], "vintagedelight:vinegar_bottle")
    .id("create:filling/emptying/vintagedelight/vinegar_bottle")
    e.recipes.create.emptying(["vintagedelight:mason_jar", Fluid.of("rimcraft:vinegar", 750)], "vintagedelight:vinegar_mason_jar")
    ...
    fermenting(e,"2x minecraft:ochre_froglight", [
        Fluid.of("rimcraftcore:slime", 810),
        "minecraft:blaze_powder",
        "minecraft:magma_cream",
        "vintagedelight:salt_block",
        Fluid.of("rimcraft:vinegar", 250)
    ])
