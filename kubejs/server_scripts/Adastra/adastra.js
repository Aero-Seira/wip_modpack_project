ServerEvents.recipes(e => {
    ...
    e.replaceInput({ id: "ad_astra:oxygen_distributor" }, "ad_astra:oxygen_loader", "rimcraft:electrolyzer")
    ...
    //替换配方：氧气装载机
    e.recipes.kubejs.shaped('rimcraft:electrolyzer', [
        "AAA",
        "BCB",
        "ADA"
    ], {
    ...
    e.recipes.create.mixing(
        Fluid.of("rimcraft:fuel_mixtures", 100),
        [
    ...
    e.recipes.create.mixing(
        Fluid.of("rimcraft:fuel_mixtures", 200),
        [
            Fluid.of("createdieselgenerators:gasoline", 50),
    ...
    e.recipes.create.mixing(Fluid.of("rimcraft:ice_lubricating_oil", 500), [Fluid.of("rimcraft:lubricating_oil", 250), "ad_astra:ice_shard"])
    .heatRequirement("frozen")
    .id("rimcraft:mixing/ice_lubricating_oil")
    e.recipes.create.mixing(Fluid.of("rimcraft:ice_lubricating_oil", 500), [Fluid.of("rimcraft:lubricating_oil", 250), Fluid.of("rimcraft:ice_dragon_blood", 25)])
    .id("rimcraft:mixing/ice_lubricating_oil_from_ice_dragon_blood")
})
