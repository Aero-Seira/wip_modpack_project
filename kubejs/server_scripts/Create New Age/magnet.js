ServerEvents.recipes(e => {
    ...
    // 铁金介质磁铁
    let iner_3 = "rimcraft:incomplete_layered_magnet"
    ...
    e.recipes.vintageimprovements.pressurizing(
        ...
        [
            ...
            Fluid.of("rimcraftcore:molten_azure_neodymium", 180)
        ]
    ...
    e.recipes.vintageimprovements.pressurizing(
        ...
        [
            "create_new_age:fluxuated_magnetite",
            Fluid.of("createmetallurgy:molten_netherite", 180),
            Fluid.of("rimcraftcore:molten_scarlet_neodymium", 180),
        ]
    ).heated().id("create_new_age:shaped/netherite_magnet_2")
    // 碳刷
    let iner_4 = "rimcraft:incomplete_carbon_brushes"
    e.recipes.create.sequenced_assembly('create_new_age:carbon_brushes', 'create:shaft',
        [
            ...
            e.recipes.create.deploying(iner_4, [iner_4, "rimcraft:carbon_plate"]),
            e.recipes.create.filling(iner_4, [iner_4, Fluid.of("rimcraftcore:molten_andesite",810)])
        ]
    )
        .loops(1)
