ServerEvents.recipes(e => {
    ...
    //基础电机
    let iner = "rimcraft:incomplete_basic_motor"
    ...
    //高级电机
    let iner_1 = "rimcraft:incomplete_advanced_motor"
    ...
    //超级电机
    let iner_2 = "rimcraft:incomplete_reinforced_motor"
    e.recipes.create.sequenced_assembly("2x create_new_age:reinforced_motor", "create_new_age:advanced_motor",
        [
            ...
            e.recipes.create.deploying(iner_2, [iner_2, "rimcraft:magnetic_mechanism"]),
    ...
    // //行星齿轮
    // let iner_3 = "rimcraft:incomplete_planet_gear"
    // e.recipes.create.sequenced_assembly("rimcraft:planet_gear", "create:brass_sheet", 
    //     [
    ...
    //         e.recipes.create.filling(iner_3, [iner_3, Fluid.of("rimcraft:lubricating_oil", 100)])
    //     ]
    // )
    //     .loops(1)
    //     .transitionalItem(iner_3)
    //     .id("rimcraft:sequenced_assembly/planet_gear")
    // //基础电机超频器
