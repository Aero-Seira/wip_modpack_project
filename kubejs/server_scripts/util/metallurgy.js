...
byProductMap.set("rimcraft:tin_dust", ["minecraft:glowstone_dust", 0.5])
byProductMap.set("rimcraft:silver_dust", ["vintageimprovements:sulfur_chunk", 0.5])
byProductMap.set("rimcraft:desh_dust", ["ad_astra:cheese", 0.2])
byProductMap.set("rimcraft:ostrum_dust", ["iceandfire:myrmex_desert_resin", 0.2])
byProductMap.set("rimcraft:calorite_dust", ["iceandfire:deathworm_egg", 0.2])
/**
 * 
 * @param { Internal.RecipesEventJS_ } event 
...
function metal_production_line_5(event, metal) {
    ...
    event.recipes.rimcraft.small_centrifugation()
