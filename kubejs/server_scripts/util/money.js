...
MoneyUtil.convertBaseValueToString = function(values) {
    ...
    if (values > 0)
        MoneyUtil.convertBaseValueToItems(values).forEach(item => {
            switch(item.id) {
                case "rimcraftcore:iron_coin":
                    component.append(item.count.toString()).append(Component.of("§f\uAA01§r").font("rimcraft:coin_font")).append(" ")
                    break
                case "rimcraftcore:copper_coin":
                    component.append(item.count.toString()).append(Component.of("§f\uAA02§r").font("rimcraft:coin_font")).append(" ")
                    break
                case "rimcraftcore:gold_coin":
                    component.append(item.count.toString()).append(Component.of("§f\uAA03§r").font("rimcraft:coin_font")).append(" ")
                    break
                case "rimcraftcore:emerald_coin":
                    component.append(item.count.toString()).append(Component.of("§f\uAA04§r").font("rimcraft:coin_font")).append(" ")
                    break
                case "rimcraftcore:netherite_coin":
                    component.append(item.count.toString()).append(Component.of("§f\uAA05§r").font("rimcraft:coin_font")).append(" ")
                    break
            }
        })
    else
        component = Component.of("§f\uAA01§r").font("rimcraft:coin_font")
    return component
}
/**
 * 
