...
ServerEvents.recipes(e => {
    ...
    e.replaceInput({ id: "corn_delight:cooking/corn_soup" }, "culturaldelights:corn_cob", "rimcraft:corn_flour")
    ...
    e.replaceInput({ id: "corn_delight:cooking/creamy_corn_drink" }, "culturaldelights:corn_cob", "rimcraft:corn_flour")
    ...
    e.recipes.create.milling(
        [
            "2x rimcraft:corn_flour",
            Item.of("2x rimcraft:corn_flour").withChance(0.5)
        ],
        "culturaldelights:corn_kernels"
    ).id("rimcraft:milling/corn_flour")
    e.recipes.create.mixing("culturaldelights:corn_dough", [
        Fluid.water(50),
        "rimcraft:corn_flour"
    ]).id("culturaldelights:mixing/corn_dough")
    e.recipes.create.splashing("culturaldelights:corn_dough", "rimcraft:corn_flour")
