ServerEvents.recipes(e => {
  ...
  "rimcraftcore:fragment_of_border",
  [
    "alexsmobs:shattered_dimensional_carver",
    "ae2:singularity",
  ]).keepIngredient("alexsmobs:shattered_dimensional_carver").id("rimcraftcore:fragment_of_border_from_shattered_dimensional_carver")
  e.recipes.kubejs.shapeless(
