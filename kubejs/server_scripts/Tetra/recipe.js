ServerEvents.recipes(e => {
    ...
    create.deploying(["tetra:forged_mesh", Item.of("art_of_forging:nano_insectoid").withChance(0.1)], ["rimcraft:forged_steel_sheet", "art_of_forging:nano_insectoid"])
    .keepHeldItem()
    ...
    create.deploying("2x tetra:forged_bolt", ["tetra:forged_beam", "rimcraft:forged_steel_sheet"])
