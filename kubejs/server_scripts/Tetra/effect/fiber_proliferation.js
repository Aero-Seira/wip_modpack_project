EntityEvents.drops(e => {
    ...
    if (!(item instanceof $ModularItem) || !TetraUtil.itemHasEffect(mainhandItem, "rimcraft:fiber_proliferation"))
        return
    let level = TetraUtil.getEffectLevel(mainhandItem, "rimcraft:fiber_proliferation")
    let effciency = TetraUtil.getEffectEfficiency(mainhandItem, "rimcraft:fiber_proliferation")
