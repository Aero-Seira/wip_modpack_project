ServerEvents.tags("minecraft:item", e => {
    ...
    e.add("rimcraft:order/fast_food",
        "#rimcraft:order/burger",
    ...
    e.add("rimcraft:order/ice_cream",
    ...
    e.add("rimcraft:order/western_wine",
        "vinery:mead",
        "vinery:apple_cider",
        "vinery:apple_wine",
        "vinery:mellohi_wine",
    ...
    e.add("rimcraft:order/eastern_wine",
    ...
    e.add("rimcraft:order/fried_food",
    ...
    e.add("rimcraft:order/vegetable",
        "minecraft:potato",
        "minecraft:carrot",
        "minecraft:beetroot",
    ...
    e.add("rimcraft:order/jello",
        "#fruitsdelight:jello"
    )
    e.add("rimcraft:order/gummy",
        "#collectorsreap:gummies"
    )
    e.add("rimcraft:order/coffee",
    ...
    e.add("rimcraft:order/wine",
        ''
    )
    e.add("rimcraft:order/drink",
        "#rimcraft:order/western_wine",
        "#rimcraft:order/eastern_wine",
        "#rimcraft:order/tea",
        "#rimcraft:order/milk_tea",
        "#rimcraft:order/coffee",
        "#rimcraft:order/juice",
    ...
    e.add("rimcraft:order/food",
        "#rimcraft:order/fast_food",
        "#rimcraft:order/cookie",
        "#rimcraft:order/sandwich",
        "rimcraft:order/fried_food",
        "#rimcraft:order/bread"
    )
    e.add("rimcraft:order/dessert",
    ...
    e.add("rimcraft:order/snack",
        "#rimcraft:order/jello",
        "#rimcraft:order/ice_cream",
        "#rimcraft:order/cookie",
    ...
    e.add("rimcraft:order/meat_dish",
    ...
    e.add("rimcraft:order/vegetarian_dish",
    ...
    e.add("rimcraft:order/sausage",
        "#forge:sausage"
    )
    e.add("rimcraft:order/mixed_dish",
    ...
    e.add("rimcraft:order/milkshake",
    ...
    e.add("rimcraft:order/staple_food",
        "#rimcraft:order/noodle",
        "#rimcraft:order/bread",
