ServerEvents.recipes(e => {
    ...
    .id("rimcraft:casting_in_basin/golden_carrot_crate")
    ...
    "minecraft:amethyst_block", [
        create.filling("minecraft:amethyst_block", ["minecraft:amethyst_block", Fluid.of("rimcraft:spent_liquor", 1000)]),
    ...
    create.compacting(Fluid.of("rimcraft:unrefined_sugar", 500),
     ["minecraft:sugar_cane", Fluid.water(250)])
    .id("rimcraft:compacting/unrefined_sugar_from_sugar_cane")
    create.compacting(Fluid.of("rimcraft:unrefined_sugar", 500),
     ["2x minecraft:beetroot", Fluid.water(250)])
    .id("rimcraft:compacting/unrefined_sugar_from_beetroot")
    create.compacting(Fluid.of("rimcraft:unrefined_sugar", 500),
     ["3x alexscaves:licoroot_vine", Fluid.water(250)])
    .id("rimcraft:compacting/unrefined_sugar_from_licoroot_vine")
    vintageimprovements.pressurizing([Fluid.of("rimcraft:base_syrup", 100), Fluid.water(100)], Fluid.of("rimcraft:unrefined_sugar", 200))
    .secondaryFluidOutput(1)
    .heated()
    .id("rimcraft:pressurizing/melted_sugar")
