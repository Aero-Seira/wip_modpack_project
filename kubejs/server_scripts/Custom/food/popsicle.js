...
ServerEvents.recipes(e => {
    ...
    let popsicle_recipe_list = [
        ['rimcraft:empty_popsicle', Fluid.of("the_bumblezone:sugar_water_still", 100)],
        ['ends_delight:chorus_fruit_popsicle', Fluid.of("rimcraftcore:chorusslime", 100)],
        ...
        ['casualness_delight:green_tongue', Fluid.of("rimcraftcore:slime")],
    ]
    popsicle_recipe_list.forEach(popsicle => {
        let iner = "ratatouille:popsicle_mold"
        e.recipes.create.sequenced_assembly(`rimcraft:${popsicle[0].split(":")[1]}_mold_filled`, iner, [
        ...
        freezing(e, `rimcraft:${popsicle[0].split(":")[1]}_mold_filled`, `rimcraft:${popsicle[0].split(":")[1]}_mold_solid`, 200)
        e.recipes.ratatouille.demolding([popsicle[0], 'ratatouille:popsicle_mold'], `rimcraft:${popsicle[0].split(":")[1]}_mold_solid`).id(`ratatouille:demolding/${popsicle[0].split(":")[1]}`)
    })
...
ItemEvents.foodEaten('cmr:frozen_cake', e => {
    ...
    // e.recipes.kubejs.shaped("rimcraft:empty_popsicle", [
    //     " AA",
    //     "ABA",
    //     "CA "
    // ],
    ...
    //         C: "minecraft:stick"
    //     })
    //     .id("rimcraft:shaped/empty_popsicle")
    // let iner_1 = "minecraft:stick"
    // e.recipes.create.sequenced_assembly("rimcraft:empty_popsicle", iner_1, [
    //     e.recipes.create.deploying(iner_1, [iner_1, "#forge:ice_cubes"]),
    //     e.recipes.create.deploying(iner_1, [iner_1, "minecraft:sugar"])
    // ])
    //     .transitionalItem(iner_1)
    //     .loops(1)
    //     .id("rimcraft:sequenced_assembly/empty_popsicle")
    ...
    //         {
    //             A: ingredientItem,
    //             B: "rimcraft:empty_popsicle"
    //         })
    //         .id(`rimcraft:shaped/${result.split(":")[1]}`)
    //     }
    //     if (ingredientFluid != null) {
    //         e.recipes.create.filling(result, [
    //             "rimcraft:empty_popsicle",
    //             ingredientFluid])
    //             .id(`rimcraft:filling/${result.split(":")[1]}`)
    //     }
    // }
    ...
    // make_popsicle("casualness_delight:green_tongue", "minecraft:slime_ball", Fluid.of("rimcraftcore:slime", 90))
    // make_popsicle("collectorsreap:lime_popsicle", "#forge:fruits/lime", Fluid.of("rimcraft:limeade", 250))
    // // make_popsicle("youkaishomecoming:milk_popsicle", "#forge:milk/milk_bottle", Fluid.of("minecraft:milk", 250))
    // e.recipes.create.deploying("youkaishomecoming:big_popsicle", ["rimcraft:empty_popsicle", "#forge:ice_cubes"])
    // e.recipes.create.deploying('mynethersdelight:tear_popsicle', ['rimcraft:empty_popsicle', "minecraft:ghast_tear"])
    // .id("rimcraft:deploying/big_popsicle")
    // //西瓜冰棍配方替换
    ...
    //         B: "rimcraft:empty_popsicle"
    //     }
    // ).id("rimcraft:shaped/milk_popsicle")
    ...
    //     ]
    // ).id("rimcraft:filling/milk_popsicle")
