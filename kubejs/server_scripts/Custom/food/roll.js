ServerEvents.recipes(e => {
    ...
    function cutting_roll(input, output) {
        e.recipes.create.cutting(Item.of(output, 3), input)
            .id(`rimcraft:cutting/${output.split(":")[1]}`)
    }
    /**
     * 
     * @param {InputItem_} input 
    ...
    function sushi(input, output) {
        e.recipes.create.deploying(output, ["rimcraft:empty_riceball", input])
            .id(`rimcraft:deploying/sushi/${output.split(":")[1]}`)
    }
    /**
     * 
     * @param {InputItem_} input 
    ...
    function gunkan(input, output) {
        let iner = "rimcraft:incomplete_gunkan"
        e.recipes.create.sequenced_assembly(output, "rimcraft:empty_riceball", [
            e.recipes.create.deploying(iner, [iner, input]),
            e.recipes.create.deploying(iner, [iner, "minecraft:dried_kelp"])
        ])
            .transitionalItem(iner)
            .loops(1)
            .id(`rimcraft:sequenced_assembly/gunkan/${output.split(":")[1]}`)
    }
    /**
     * 
     * @param {InputItem_} input 
    ...
    function nigiri(input, output) {
        let iner = "rimcraft:incomplete_nigiri"
        e.recipes.create.sequenced_assembly(output, "rimcraft:empty_riceball", [
            e.recipes.create.deploying(iner, [iner, input]),
            e.recipes.create.deploying(iner, [iner, "minecraft:dried_kelp"])
        ])
            .transitionalItem(iner)
            .loops(1)
            .id(`rimcraft:sequenced_assembly/nigiri/${output.split(":")[1]}`)
    }
    /**
     * 
    ...
    function hosomaki(ingredient, output) {
        let iner = "rimcraft:incomplete_hosomaki"
        e.recipes.create.sequenced_assembly(output, "minecraft:dried_kelp", [
                ...
                e.recipes.create.deploying(iner, [iner, "rimcraft:empty_riceball"])
            ]
        )
            .transitionalItem(iner)
            .loops(1)
            .id(`rimcraft:sequenced_assembly/hosomaki/${output.split(":")[1]}`)
    }
    /**
     * 
    ...
    function futomaki(ingredients, output) {
        let iner = "rimcraft:incomplete_futomaki"
        let recipes = []
        ...
        recipes.push(e.recipes.create.deploying(iner, [iner, "rimcraft:empty_riceball"]))
        recipes.push(e.recipes.create.deploying(iner, [iner, "rimcraft:empty_riceball"]))
        ...
        e.recipes.create.sequenced_assembly(output, "minecraft:dried_kelp", recipes)
            .transitionalItem(iner)
            .loops(1)
            .id(`rimcraft:sequenced_assembly/futomaki/${output.split(":")[1]}`)
    }

    e.replaceInput({}, "farmersdelight:cooked_rice", "rimcraft:empty_riceball")
    e.recipes.kubejs.shapeless("rimcraft:empty_riceball", "farmersdelight:cooked_rice")
        .replaceIngredient({ item: "farmersdelight:cooked_rice" }, "minecraft:bowl")
        .id("rimcraft:empty_riceball_from_cooked_rice")
    e.recipes.kubejs.shapeless("farmersdelight:cooked_rice", ["rimcraft:empty_riceball", "minecraft:bowl"])
        .id("rimcraft:cooked_rice_from_empty_riceball")
    e.recipes.minecraft.smoking("rimcraft:empty_riceball", "farmersdelight:rice")
        .id("rimcraft:empty_riceball_from_rice")
    e.recipes.farmersdelight.cutting(
        "alexscaves:deep_sea_sushi_roll",
        "#forge:tools/knives",
        "3x rimcraft:deep_sea_sushi_roll_slice"
    ...
    cutting_roll("alexscaves:deep_sea_sushi_roll", "rimcraft:deep_sea_sushi_roll_slice")
    ...
    sushi("crabbersdelight:cooked_pufferfish_slice", "2x rimcraft:fugu_roll")
    ...
    sushi("alexscaves:radgill", "2x rimcraft:radgill_sushi")
    ...
    {
        let iner = "rimcraft:incomplete_california"
        e.recipes.create.sequenced_assembly('youkaishomecoming:california_roll', 'rimcraft:empty_riceball', [
            e.recipes.create.deploying(iner, [iner, 'rimcraft:empty_riceball']),
            e.recipes.create.deploying(iner, [iner, 'minecraft:dried_kelp']),
