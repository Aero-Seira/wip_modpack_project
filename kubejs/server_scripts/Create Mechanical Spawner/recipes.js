ServerEvents.recipes(e => {
    ...
    e.replaceInput([{ id: "create_mechanical_spawner:mechanical_spawner" }, { id: "create_mechanical_spawner:loot_collector" }], "create:brass_ingot", "rimcraftcore:bronze_ingot")
    ...
    // vintageimprovements.vacuumizing('rimcraft:inferior_genetic_seed', [
    ...
    vintageimprovements.vacuumizing('16x rimcraft:inferior_genetic_seed', inferior_genetic_seed_input.concat(Fluid.of("netherexp:ectoplasm", 250)))
    .id("create_mechanical_spawner:vacuumizing/inferior_genetic_seed_2")
    
    create.emptying([
        Fluid.of("create_mechanical_spawner:spawn_fluid_random", 50),
        Item.of("rimcraft:normal_genetic_seed").withChance(0.4)],
    ...
    create.emptying([
        ...
        Item.of("rimcraft:refined_genetic_seed").withChance(0.4)],
    ...
    create.emptying([
        ...
        Item.of("rimcraft:pure_genetic_seed").withChance(0.4)],
        'rimcraft:refined_genetic_seed')
    .id("create_mechanical_spawner:emptying/pure_genetic_seed")


    create.compacting(Fluid.of("create_mechanical_spawner:spawn_fluid_random", 50), "rimcraft:inferior_genetic_seed")
    .id("create_mechanical_spawner:emptying/spawn_fluid_random_from_inferior_genetic_seed")
    create.compacting(Fluid.of("create_mechanical_spawner:spawn_fluid_random", 100), "rimcraft:normal_genetic_seed")
    .id("create_mechanical_spawner:emptying/spawn_fluid_random_from_normal_genetic_seed")
    create.compacting(Fluid.of("create_mechanical_spawner:spawn_fluid_random", 200), "rimcraft:refined_genetic_seed")
    .id("create_mechanical_spawner:emptying/spawn_fluid_random_from_refined_genetic_seed")
    create.compacting(Fluid.of("create_mechanical_spawner:spawn_fluid_random", 400), "rimcraft:pure_genetic_seed")
    ...
    function create_spawn_fluid(e, input, output, baseAmount, tier) {
        if (tier >= 5) {
            e.recipes.create.mixing(
                [Fluid.of(output, baseAmount), Item.of("rimcraft:inferior_genetic_seed").withChance(0.5)],
                input.concat(Item.of("rimcraft:inferior_genetic_seed"), Fluid.of("create_mechanical_spawner:spawn_fluid_random", baseAmount)))
            .id(`create_mechanical_spawner:${output.split(":")[1]}_from_inferior_genetic_seed`)
        }
        if (tier >= 4) {
            e.recipes.create.mixing(
                [Fluid.of(output, baseAmount * 1.5), Item.of("rimcraft:normal_genetic_seed").withChance(0.65)],
                input.concat(Item.of("rimcraft:normal_genetic_seed"), Fluid.of("create_mechanical_spawner:spawn_fluid_random", baseAmount * 1.5)))
            .id(`create_mechanical_spawner:${output.split(":")[1]}_from_normal_genetic_seed`)
        }
        if (tier >= 3) {
            e.recipes.create.mixing(
                [Fluid.of(output, baseAmount * 2), Item.of("rimcraft:refined_genetic_seed").withChance(0.8)],
                input.concat(Item.of("rimcraft:refined_genetic_seed"), Fluid.of("create_mechanical_spawner:spawn_fluid_random", baseAmount * 2)))
            .id(`create_mechanical_spawner:${output.split(":")[1]}_from_refined_genetic_seed`)
        }
        if (tier >= 2) {
            e.recipes.create.mixing(
                [Fluid.of(output, baseAmount * 2.5), Item.of("rimcraft:pure_genetic_seed").withChance(0.95)],
                input.concat(Item.of("rimcraft:pure_genetic_seed"), Fluid.of("create_mechanical_spawner:spawn_fluid_random", baseAmount * 2.5)))
            .id(`create_mechanical_spawner:${output.split(":")[1]}_from_pure_genetic_seed`)
        }
        if (tier >= 1) {
            e.recipes.create.mixing(
                [Fluid.of(output, baseAmount * 4), Item.of("rimcraft:flawless_genetic_seed")],
                input.concat(Item.of("rimcraft:flawless_genetic_seed"), Fluid.of("create_mechanical_spawner:spawn_fluid_random", baseAmount * 4)))
    ...
    create_spawn_fluid(e, ["rimcraftcore:emerald_coin", Fluid.of("butchercraft:blood_fluid", 500)], "create_mechanical_spawner:spawn_fluid_evoker", 200, 2)
