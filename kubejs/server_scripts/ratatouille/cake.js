ServerEvents.recipes(e => {
    ...
    // 蛋糕相关
    e.recipes.create.mixing(
        Fluid.of("rimcraft:cake_batter", 1000),
        [
    ...
    e.recipes.create.filling(
        ...
        [
            ...
            Fluid.of("rimcraft:cake_batter", 500)
        ]
    ...
    e.recipes.create.sequenced_assembly("farmersrespite:coffee_cake", "ratatouille:cake_base", [
        e.recipes.create.filling("ratatouille:cake_base", ["ratatouille:cake_base", Fluid.of("rimcraft:espresso_fluid", 1000)]),
