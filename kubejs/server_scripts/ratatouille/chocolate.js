...
ServerEvents.recipes(e => {
    ...
    e.recipes.create.filling(
        "rimcraftcore:black_chocolate_mold_filled",
        [
            Fluid.of("create_confectionery:black_chocolate", 250),
    ...
    e.custom({
        ...
        "ingredients": [
            {
                "item": "rimcraftcore:black_chocolate_mold_solid"
            }
        ],
        "results": [
            {
    ...
    e.recipes.create.filling(
        "rimcraftcore:white_chocolate_mold_filled",
        [
            Fluid.of("create_confectionery:white_chocolate", 250),
            "ratatouille:chocolate_mold"
        ]
    ...
    e.custom({
        ...
        "ingredients": [
            {
                "item": "rimcraftcore:white_chocolate_mold_solid"
            }
        ],
        "results": [
            {
    ...
    e.recipes.create.filling(
        "rimcraftcore:ruby_chocolate_mold_filled",
        [
            Fluid.of("create_confectionery:ruby_chocolate", 250),
            "ratatouille:chocolate_mold"
        ]
    ...
    e.custom({
        ...
        "ingredients": [
            {
                "item": "rimcraftcore:ruby_chocolate_mold_solid"
            }
        ],
        "results": [
            {
    ...
    freezing(e, 'rimcraftcore:black_chocolate_mold_filled', 'rimcraftcore:black_chocolate_mold_solid', 60)
    freezing(e, 'rimcraftcore:white_chocolate_mold_filled', 'rimcraftcore:white_chocolate_mold_solid', 60)
    freezing(e, 'rimcraftcore:ruby_chocolate_mold_filled', 'rimcraftcore:ruby_chocolate_mold_solid', 60)
})
