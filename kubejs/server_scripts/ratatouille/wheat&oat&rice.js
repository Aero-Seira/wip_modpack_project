...
ServerEvents.recipes(e => {
    ...
    e.recipes.create.emptying([
        Fluid.of("rimcraft:egg_yolk", 250),
        "ratatouille:egg_shell"
    ], "#forge:eggs"
    ).id("create:emptying/yolk")
    e.recipes.create.emptying([
        Fluid.of("rimcraft:egg_yolk", 1000),
        "ratatouille:egg_shell"
    ], "#forge:bigger_eggs"
    ).id("create:emptying/more_yolk")
    //人工蛋液适配
    e.recipes.create.mixing(
        Fluid.of("rimcraft:artificial_egg_yolk", 250),
        [
            Fluid.of("rimcraft:soya_milk", 250),
            Fluid.of("rimcraftcore:slime", 30)
        ]
    ).id("rimcraft:mixing/artificial_egg_yolk")
    // 面团相关
    // 恶魂面团
