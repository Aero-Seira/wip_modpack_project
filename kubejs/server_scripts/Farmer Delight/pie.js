ServerEvents.tags("item", e => {
    e.add("rimcraft:sculk_food_root", [
...
ServerEvents.recipes(e => {
    ...
    baking(e, "rimcraft:puff_pastry", "farmersdelight:pie_crust", 1, "food", 100)
    e.recipes.kubejs.shapeless(
        "silentsdelight:sculk_catalyst_pie_crust",
        [
            "farmersdelight:pie_crust",
            "#rimcraft:sculk_food_root"
        ]
    ).id("rimcraft:crafting/sculk_catalyst_pie_crust")
    ...
    ).id("rimcraft:deploying/sculk_catalyst_pie")
    let pie_recipes = [
    ...
    ).id("rimcraft:cooking/chorus_fruit_pie")
    e.recipes.farmersdelight.cooking(
        [
    ...
    ).id("rimcraft:cooking/stargazy_pie")
    e.recipes.farmersdelight.cooking(
        [
            "#forge:seafood",
            "#forge:cheese",
    ...
    ).id("rimcraft:cooking/quiche_lorraine")
    e.recipes.farmersdelight.cooking(
        [
            "#forge:eggs",
            "minecraft:sugar",
    ...
    ).id("rimcraft:cooking/lemon_tart")
    e.recipes.farmersdelight.cooking(
       [
