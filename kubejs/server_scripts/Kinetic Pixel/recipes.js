ServerEvents.recipes(e => {
    ...
    create.mixing(
        "4x rimcraft:guncotton",
        [
            FluidIngredients("forge:acid", 100),
            "minecraft:gunpowder",
            "minecraft:paper"
        ]
    ).id("rimcraft:mixing/guncotton_paper_gunpowder")
    create.mixing(
        "4x rimcraft:guncotton",
        [
            FluidIngredients("forge:acid", 100),
    ...
    ).id("rimcraft:mixing/guncotton_paper_lumisene")

    create.mixing(
        "16x rimcraft:guncotton",
        [
            FluidIngredients("forge:acid", 100),
            "minecraft:gunpowder",
            "kinetic_pixel:graycotton"
        ]
    ).id("rimcraft:mixing/guncotton_graycotton_gunpowder")
    create.mixing(
        "16x rimcraft:guncotton",
        [
            FluidIngredients("forge:acid", 100),
    ...
    ).id("rimcraft:mixing/guncotton_graycotton_lumisene")
    ...
    let iner = 'rimcraft:incomplete_slap'
    create.sequenced_assembly(Item.of('tacz:ammo', '{AmmoId:"create_armorer:slap"}').withCount(2), 'create:brass_sheet',
        [
            ...
            create.deploying(iner, [iner, 'rimcraft:guncotton']),
    ...
    let iner_1 = 'rimcraft:incomplete_rbapb'
    create.sequenced_assembly(Item.of('tacz:ammo', '{AmmoId:"create_armorer:rbapb"}'), 'create:brass_sheet',
        [
            ...
            create.deploying(iner_1, [iner_1, 'rimcraft:guncotton']),
    ...
    create.filling(Item.of('tacz:modern_kinetic_gun', '{GunId:"create_armorer:special_melee_wrench"}'), [
        "create:wrench",
        Fluid.of("rimcraft:malice_solution", 1000)
