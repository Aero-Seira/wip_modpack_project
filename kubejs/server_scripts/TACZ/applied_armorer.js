 ...
 */
    ...
    transform_fluid(Item.of('tacz:ammo', '{AmmoId:"applied_armorer:cluster_quartz_bullet"}'), "rimcraft:spent_liquor", [
        "#forge:dusts/ender_pearl",
        "#forge:dusts/certus_quartz",
        Item.of('tacz:ammo', '{AmmoId:"tacz:12g"}').strongNBT()
    ]).id("applied_armorer:cluster_quartz_bullet")
    transform_fluid(Item.of('tacz:ammo', '{AmmoId:"applied_armorer:hard_core_quartz_bullet"}'), "rimcraft:spent_liquor", [
        "#forge:dusts/ender_pearl",
        "#forge:dusts/certus_quartz",
        Item.of('tacz:ammo', '{AmmoId:"create_armorer:slap"}').strongNBT()
    ]).id("applied_armorer:hard_core_quartz_bullet")
    transform_fluid(Item.of('tacz:ammo', '{AmmoId:"applied_armorer:etched_quartz_bullet"}'), "rimcraft:spent_liquor", [
        "#forge:dusts/ender_pearl",
        "#forge:dusts/certus_quartz",
        Item.of('tacz:ammo', '{AmmoId:"create_armorer:rbapb"}').strongNBT()
    ]).id("applied_armorer:etched_quartz_bullet")
    transform_fluid(Item.of('tacz:ammo', '{AmmoId:"applied_armorer:fluix_infused_grenade"}'), "rimcraft:spent_liquor", [
        "#forge:dusts/ender_pearl",
        "#forge:dusts/certus_quartz",
        Item.of("protection_pixel:pneumaticgrenade")
    ]).id("applied_armorer:fluix_infused_grenade")
    transform_fluid(Item.of('tacz:modern_kinetic_gun', '{GunCurrentAmmoCount:0,GunFireMode:"SEMI",GunId:"applied_armorer:niklas_pistol_semi_union",HasBulletInBarrel:0b}'), "rimcraft:spent_liquor", [
    ...
    transform_fluid(Item.of('tacz:modern_kinetic_gun', '{GunCurrentAmmoCount:0,GunFireMode:"SEMI",GunId:"applied_armorer:niklas_smg_freedom",HasBulletInBarrel:0b}'), "rimcraft:spent_liquor", [
        "#forge:storage_blocks/sky_steel",
        "#forge:storage_blocks/iron",
        "ae2:singularity",
