ServerEvents.recipes(e => {
    ...
    create.mixing(Fluid.of("rimcraft:base_syrup", 125), "minecraft:sugar")
    .heated()
    .id("createcafe:mixing/sugar_melting")
    vintageimprovements.vacuumizing("minecraft:sugar", Fluid.of("rimcraft:base_syrup", 125)).id("createcafe:vacuumizing/melted_sugar_vacuumizing")
    create.compacting("rimcraftcore:base_syrup", Fluid.of("rimcraft:base_syrup", 1000)).id("createcafe:compacting/base_syrup")
    create.compacting("rimcraftcore:strawberry_syrup", Fluid.of("rimcraft:strawberry_syrup", 1000)).id("createcafe:compacting/strawberry_syrup")
    create.compacting("rimcraftcore:banana_syrup", Fluid.of("rimcraft:banana_syrup", 1000)).id("createcafe:compacting/banana_syrup")
    create.compacting("rimcraftcore:vanilla_syrup", Fluid.of("rimcraft:vanilla_syrup", 1000)).id("createcafe:compacting/vanilla_syrup")
    create.compacting("rimcraftcore:mint_syrup", Fluid.of("rimcraft:mint_syrup", 1000)).id("createcafe:compacting/mint_syrup")
    create.mixing(
        Fluid.of("rimcraft:vanilla_syrup", 250),
        [
    ...
    create.mixing(
        Fluid.of("rimcraft:banana_syrup", 250),
        [
            Fluid.of("rimcraft:base_syrup", 250),
            '#forge:fruits/banana'
        ]
    ...
    create.mixing(
        Fluid.of("rimcraft:strawberry_syrup", 250),
        [
            Fluid.of("rimcraft:base_syrup", 250),
    ...
    create.mixing(
        Fluid.of("rimcraft:mint_syrup", 250),
        [
            Fluid.of("rimcraft:base_syrup", 250),
    ...
    create.mixing(
        Fluid.of("rimcraft:filling", 1000),
        [
            Fluid.of("rimcraft:base_syrup", 1000),
    ...
    ).id("createcafe:filling/coffee/banana_iced_coffee_filling")
    {
        ...
        create.sequenced_assembly('createcafe:oreo', 'createcafe:oreo_half', 
            [
                create.filling(iner, [iner, Fluid.of("rimcraft:filling", 250)]),
