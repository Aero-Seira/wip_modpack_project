ServerEvents.tags("minecraft:item", e => {
    ...
    e.add("forge:syrup_block", [
        'rimcraftcore:base_syrup',
        'rimcraftcore:strawberry_syrup',
        'rimcraftcore:vanilla_syrup',
        'rimcraftcore:mint_syrup',
        'rimcraftcore:banana_syrup',
...
ServerEvents.tags("minecraft:fluid", e => {
    e.add("forge:syrup", [
        'rimcraft:base_syrup',
        'rimcraft:strawberry_syrup',
        'rimcraft:vanilla_syrup',
        'rimcraft:mint_syrup',
        'rimcraft:banana_syrup',
