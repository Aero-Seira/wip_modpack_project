ServerEvents.recipes(e => {
    ...
    deep_frying("casualness_delight:fried_fish", 'rimcraftcore:unfried_fish', 100)
    deep_frying("casualness_delight:tonkatsu", 'rimcraftcore:unfried_tonkatsu', 100)
    deep_frying("casualness_delight:fried_chicken_chip", 'rimcraftcore:unfried_chicken_chip', 100)
    ...
    deep_frying('frycooks_delight:fried_potato', 'rimcraftcore:unfried_potato', 100)
    deep_frying('frycooks_delight:fried_chicken_leg', 'rimcraftcore:unfried_chicken_leg', 100)
    ...
    deep_frying('create_deepfried:calamari', 'rimcraftcore:unfried_calamari', 100)
    ...
    deep_frying('oceanic_delight:fried_shrimp', "rimcraftcore:unfried_shrimp", 100)
    ...
    deep_frying('dungeonsdelight:fried_ghast_calamari', 'rimcraft:raw_ghast_calamari', 100)
    deep_frying('cosmopolitan:potato_pancakes', 'rimcraft:raw_potato_pancake', 100)
    ...
    deep_frying("culturaldelights:empanada", "rimcraft:raw_empanada", 100)
    // 生暴辣疣猪兽排
    ...
    e.recipes.create.mixing(
        'rimcraftcore:unfried_fish',
        [
            "#minecraft:fishes",
            'bakeries:flour',
            FluidIngredients("forge:egg_yolk", 100)
        ]
    ).id("rimcraft:mixing/raw_fish")
    e.recipes.create.mixing(
        'rimcraftcore:unfried_tonkatsu',
        [
            'minecraft:porkchop',
            'bakeries:flour',
            FluidIngredients("forge:egg_yolk", 100)
        ]
    ).id("rimcraft:mixing/raw_tonkatsu")
    e.recipes.create.mixing(
        'rimcraftcore:unfried_chicken_chip',
        [
            'butchercraft:chicken_breast',
            'bakeries:flour',
            FluidIngredients("forge:egg_yolk", 100)
        ]
    ).id("rimcraft:mixing/raw_chicken_chip")
    e.recipes.create.mixing(
    ...
    ).id("rimcraft:mixing/raw_ghast_calamari")
    // 玉米热狗
    e.recipes.create.mixing(
