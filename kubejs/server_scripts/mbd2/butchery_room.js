...
MBDMachineEvents.onTick("rimcraft:butchery_room", e => {
...
MBDMachineEvents.onRemoved("rimcraft:butchery_room", e => {
  const {machine} = e.event
  let pos = machine.pos
  let facing = machine.getFrontFacing().get()
  /**@type {Internal.MeatHookBlockEntity}*/
...
MBDMachineEvents.onRecipeWorking("rimcraft:butchery_room", e => {
  const {machine} = e.event
  let pos = machine.pos
  let facing = machine.getFrontFacing().get()
  /**@type {Internal.MeatHookBlockEntity}*/
