...
MBDMachineEvents.onRecipeWorking("rimcraft:mortar", e => {
    let event = e.event
    const {machine} = event
    machine.recipeLogic.progress--
})

MBDMachineEvents.onRightClick("rimcraft:mortar", e => {
    let event = e.event
...
MBDRecipeTypeEvents.onTransferProxyRecipe("rimcraft:mortar", e => {
    let event = e.event;
