...
MBDMachineEvents.onLoad("rimcraft:mechanical_craft_encoder", e => {
    let event = e.event
    const { machine } = event
...
MBDMachineEvents.onTick("rimcraft:mechanical_craft_encoder", e => {
    let event = e.event
    const { machine } = event
...
MBDMachineEvents.onNeighborChanged("rimcraft:mechanical_craft_encoder", e => {
...
MBDMachineEvents.onUI("rimcraft:mechanical_craft_encoder", e => {
    let event = e.event
