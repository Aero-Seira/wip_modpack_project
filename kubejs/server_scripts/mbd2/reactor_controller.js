...
//自动化逻辑
  //初始化customData
MBDMachineEvents.onPlaced("rimcraft:fission_reactor_controller", e => {
  ...
  //UI实现
MBDMachineEvents.onUI("rimcraft:fission_reactor_controller", e => {
...
MBDMachineEvents.onTick("rimcraft:fission_reactor_controller", e => {
  const {machine} = e.event
