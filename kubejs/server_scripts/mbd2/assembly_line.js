...
MBDMachineEvents.onBeforeRecipeWorking("rimcraft:assembly_line", e => {
...
MBDMachineEvents.onStructureFormed("rimcraft:assembly_line", e => {
    let event = e.event
    /**
     * @type {Internal.MBDMultiblockMachine}
     */
...
MBDRecipeTypeEvents.onTransferProxyRecipe("rimcraft:assembly_line", e => {
    let event = e.event;
