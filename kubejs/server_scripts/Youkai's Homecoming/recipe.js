ServerEvents.recipes(e => {
    ...
    e.replaceInput({id: "youkaishomecoming:longevity_noodles"}, "#forge:pasta", 'rimcraft:vermicelli')
    ...
    //豆浆
    create.compacting(
        Fluid.of("rimcraft:soya_milk", 250),
        [
            Fluid.water(100),
            'youkaishomecoming:soybean'
        ]
    ).heated().id("rimcraft:compacting/soya_milk")
    ...
    e.custom({
        ...
        "outputFluid": {
            "amount": 250,
            "fluid": "rimcraft:yeast"
        },
        "results": [],
        "time": 2400
    })
        .id("rimcraft:simple_fermentation/yeast")
    fermenting(e,[
        "4x vintagedelight:organic_mash",
        Fluid.of("rimcraft:vinegar", 1000)
    ], [
        "#forge:mushrooms",
    ...
    coffee_list.forEach(coffee => {
        create.filling(`youkaishomecoming:${coffee}`, ["minecraft:glass_bottle", Fluid.of(`rimcraft:${coffee}_fluid`, 250)])
            .id(`youkaishomecoming:filling/${coffee}_from_fluid`)
        create.emptying(["minecraft:glass_bottle", Fluid.of(`rimcraft:${coffee}_fluid`, 250)], `youkaishomecoming:${coffee}`)
    ...
    tea_list.forEach(tea => {
        create.filling(`youkaishomecoming:${tea}`, ["minecraft:glass_bottle", Fluid.of(`rimcraft:${tea}`, 250)])
            .id(`youkaishomecoming:filling/${tea}`)
        create.emptying(["minecraft:glass_bottle", Fluid.of(`rimcraft:${tea}`, 250)], `youkaishomecoming:${tea}`)
            .id(`youkaishomecoming:emptying/${tea}`) 
    })

    pouring(e, Item.of('minecraft:potion', '{Potion:"minecraft:water"}').strongNBT(), "minecraft:water")
    brewing(e, "minecraft:water", ["createcafe:coffee_grounds", "createcafe:coffee_grounds"], "rimcraft:espresso_fluid", "youkaishomecoming:espresso")
    brewing(e, "minecraft:water", ["createcafe:coffee_grounds"], "rimcraft:americano_fluid", "youkaishomecoming:americano")
    brewing(e, "rimcraft:espresso_fluid", ["createcafe:coffee_grounds"], "rimcraft:ristretto_fluid", "youkaishomecoming:ristretto")
    brewing(e, "rimcraft:espresso_fluid", ["#forge:milk/milk_bottle"], "rimcraft:latte_fluid", "youkaishomecoming:latte")
    brewing(e, "rimcraft:espresso_fluid", ["alexscaves:vanilla_ice_cream_scoop", "#forge:ice_cubes"], "rimcraft:affogato_fluid", "youkaishomecoming:affogato")
    brewing(e, "rimcraft:espresso_fluid", ['#forge:cream', "createcafe:coffee_grounds"], "rimcraft:con_panna_fluid", "youkaishomecoming:con_panna")
    brewing(e, "rimcraft:espresso_fluid", ["ratatouille:cocoa_powder", "#forge:milk/milk_bottle"], "rimcraft:mocha_fluid", "youkaishomecoming:mocha")
    brewing(e, "rimcraft:espresso_fluid", ['#forge:cream', "#forge:milk/milk_bottle"], "rimcraft:cappuccino_fluid", "youkaishomecoming:cappuccino")
    brewing(e, "rimcraft:espresso_fluid", ['#forge:cream'], "rimcraft:macchiato_fluid", "youkaishomecoming:macchiato")
    brewing(e, "butchercraft:blood_fluid", ["farmersrespite:black_tea_leaves"], "rimcraft:scarlet_tea", "youkaishomecoming:scarlet_tea")
    brewing(e, "farmersrespite:black_tea", ["fruitsdelight:lemon_slice", "minecraft:sugar"], "rimcraft:lemon_black_tea", "youkaishomecoming:lemon_black_tea")
    brewing(e, "farmersrespite:black_tea", ["ratatouille:cocoa_powder", "#forge:milk/milk_bottle"], "rimcraft:tea_mocha", "youkaishomecoming:tea_mocha")
    brewing(e, "farmersrespite:black_tea", ["minecraft:sugar", "minecraft:sugar"], "rimcraft:saidi_tea", "youkaishomecoming:saidi_tea")
    brewing(e, "minecraft:water", ["minecraft:cornflower", "minecraft:cornflower"], "rimcraft:cornflower_tea", "youkaishomecoming:cornflower_tea")
    brewing(e, "minecraft:water", ["trailandtales_delight:dried_cherry_petal", "minecraft:honey_bottle"], "rimcraft:sakura_honey_tea", "youkaishomecoming:sakura_honey_tea")
    brewing(e, "farmersrespite:green_tea", ["#forge:crops/rice", "#forge:crops/rice"], "rimcraft:genmai_tea", "youkaishomecoming:genmai_tea")
    brewing(e, "minecraft:water", ["#forge:salad_ingredients/cabbage", "#forge:salad_ingredients/cabbage"], "rimcraft:green_water", "youkaishomecoming:green_water")
    brewing(e, "minecraft:water", ["youkaishomecoming:white_tea_leaves", "youkaishomecoming:white_tea_leaves"], "rimcraft:white_tea", "youkaishomecoming:white_tea")
    brewing_2(e, "minecraft:water", ['#forge:cream', "createcafe:coffee_grounds"], "rimcraft:macchiato_fluid", "youkaishomecoming:macchiato")

    // pouring(e, "youkaishomecoming:espresso", "rimcraft:espresso_fluid")
    // pouring(e, "youkaishomecoming:americano", "rimcraft:americano_fluid")
    // pouring(e, "youkaishomecoming:ristretto", "rimcraft:ristretto_fluid")
    // brewing_2(e, "minecraft:water", ["#forge:milk/milk_bottle", "createcafe:coffee_grounds"], "rimcraft:latte_fluid", "youkaishomecoming:latte")
    // pouring(e, "youkaishomecoming:latte", "rimcraft:latte_fluid")
    // pouring(e, "youkaishomecoming:affogato", "rimcraft:affogato_fluid")
    // pouring(e, "youkaishomecoming:con_panna", "rimcraft:con_panna_fluid")
    // pouring(e, "youkaishomecoming:mocha", "rimcraft:mocha_fluid")
    // pouring(e, "youkaishomecoming:cappuccino", "rimcraft:cappuccino_fluid")
    // pouring(e, "youkaishomecoming:macchiato", "rimcraft:macchiato_fluid")
    create.mixing(
        Fluid.of("rimcraft:scarlet_tea", 1000),
        [
    ...
    create.mixing(
        Fluid.of("rimcraft:lemon_black_tea", 1000),
        [
    ...
    //         {
    //             amount: 1000,
    //             fluid: "rimcraft:tea_mocha"
    //         }
    //     ]
    // }).id("youkaishomecoming:mixing/tea_mocha")
    create.mixing(
        Fluid.of("rimcraft:saidi_tea", 1000),
        [
            Fluid.of("farmersrespite:black_tea", 1000),
            "minecraft:sugar",
            "minecraft:sugar"
    ...
    create.mixing(
        Fluid.of("rimcraft:cornflower_tea", 500),
        [
    ...
    create.mixing(
        Fluid.of("rimcraft:sakura_honey_tea", 500),
        [
            Fluid.of("minecraft:water", 500),
    ...
    create.mixing(
        Fluid.of("rimcraft:genmai_tea", 500),
        [
    ...
    create.mixing(
        Fluid.of("rimcraft:green_water", 500),
        [
            Fluid.of("minecraft:water", 500),
    ...
    create.mixing(
        Fluid.of("rimcraft:white_tea", 500),
        [
            Fluid.of("minecraft:water", 500),
    ...
    create.mixing(
        ...
        [
            Fluid.of("rimcraft:americano_fluid", 1000),
            "createcafe:coffee_grounds"
        ]
    ...
    create.compacting(
        ...
        [
            Fluid.of("rimcraft:egg_yolk", 500),
            FluidIngredients("forge:milk", 250),
            "minecraft:sugar"
        ]
