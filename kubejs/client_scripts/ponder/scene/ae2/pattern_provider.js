Ponder.registry(event => {
    event.create(["ae2:pattern_provider", "ae2:cable_pattern_provider"])
        .scene(
            "rimcraft:pattern_provider",
            "样板供应器的使用",
            "rimcraft:ponder_pattern_provider",
        ...
        .scene(
            "rimcraft:ae_crafting_parallel",
            "自动合成的并行",
            "rimcraft:ponder_ae_crafting_parallel",
    ...
    event.create(["ae2:pattern_provider", "ae2:cable_pattern_provider", "ae2:interface", "ae2:cable_interface"])
        .scene(
            "rimcraft:pattern_provider_interaction",
            "样板供应器与ME接口的联动",
            "rimcraft:ponder_pattern_provider_interaction",
