Ponder.registry(event => {
    event.create(["ae2:storage_bus"])
        .scene("rimcraft:storage_bus",
            "存储总线的使用",
            "rimcraft:ponder_storage_bus",
    ...
    event.create(["ae2:storage_bus", "ae2:interface", "ae2:cable_interface"])
        .scene("rimcraft:storage_bus_interface_interaction",
            "存储总线与ME接口的互动",
            "rimcraft:ponder_storage_bus_interface_interaction",
