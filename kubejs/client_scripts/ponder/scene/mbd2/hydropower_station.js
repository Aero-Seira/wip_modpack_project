Ponder.registry(event => {
    ...
    event.create([
        ...
        .scene(
            "rimcraft:hydropower_station",
            "大坝！水利工程的巅峰之作！",
            "rimcraft:ponder_hydropower_station",
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([8, 3, 4, 9, 3, 4], Block.id("rimcraft:steel_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([6, 3, 4, 7, 3, 4], Block.id("rimcraft:forge_steel_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([4, 3, 4, 5, 3, 4], Block.id("rimcraft:dragon_steel_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                PonderUtil.setKineticSpeed(scene, [3, 3, 4, 12, 3, 4], 32)
                scene.idle(40)
                scene.world.replaceBlocks([8, 3, 4, 9, 3, 4], Block.id("rimcraft:wooden_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([6, 3, 4, 7, 3, 4], Block.id("rimcraft:wooden_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                scene.world.replaceBlocks([4, 3, 4, 5, 3, 4], Block.id("rimcraft:wooden_fan").blockState.setValue($BlockStateProperties.HORIZONTAL_FACING, Direction.WEST), true)
                PonderUtil.setKineticSpeed(scene, [3, 3, 4, 12, 3, 4], 32)
                scene.idle(40)
