Ponder.registry(event => {
    event.create([
        ...
        .scene(
            "rimcraft:big_centrifuge",
            "大型离心机",
            "rimcraft:ponder_big_centrifuge",
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([2, 3, 4], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.WEST), true)
                scene.world.replaceBlocks([2, 6, 4], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.WEST), true)
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 任意的钢制机壳都可以被钢制输入/输出总线代替", [7, 3.5, 4.5])
                scene.world.replaceBlocks([6, 3, 4], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.EAST), true)
                scene.world.replaceBlocks([6, 6, 4], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.EAST), true)
                scene.idle(40)
                scene.rotateCameraY(90)
                scene.text(40, "在这个多方块结构中, 任意的钢制机壳都可以被钢制输入/输出总线代替", [4.5, 3.5, 7])
                scene.world.replaceBlocks([4, 3, 6], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.SOUTH), true)
                scene.world.replaceBlocks([4, 6, 6], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.SOUTH), true)
                scene.idle(40)
                ...
                scene.world.replaceBlocks([3, 3, 2, 5, 6, 2], Block.id("rimcraftcore:steel_glass_casing").blockState, true)
                scene.world.replaceBlocks([2, 4, 3, 2, 5, 5], Block.id("rimcraftcore:steel_casing").blockState, true)
                scene.world.replaceBlocks([2, 3, 3], Block.id("rimcraftcore:steel_casing").blockState, true)
                scene.world.replaceBlocks([2, 6, 3], Block.id("rimcraftcore:steel_casing").blockState, true)
                scene.world.replaceBlocks([2, 3, 5], Block.id("rimcraftcore:steel_casing").blockState, true)
                scene.world.replaceBlocks([2, 6, 5], Block.id("rimcraftcore:steel_casing").blockState, true)
                scene.idle(40)
                scene.world.replaceBlocks([3, 3, 2, 5, 6, 2], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.world.replaceBlocks([2, 4, 3, 2, 5, 5], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.world.replaceBlocks([2, 3, 3], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.world.replaceBlocks([2, 6, 3], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.world.replaceBlocks([2, 3, 5], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.world.replaceBlocks([2, 6, 5], Block.id("rimcraftcore:steel_clear_glass_casing").blockState, false)
                scene.idle(40)
                scene.addKeyframe()
        ...
        .scene(
            "rimcraft:using_big_centrifuge",
            "大型离心机的使用",
            "rimcraft:ponder_big_centrifuge_use",
            ...
            (builder, util) => {
                ...
                scene.world.replaceBlocks([2, 2, 4], Block.id("rimcraft:steel_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.WEST), true)
                scene.idle(20)
                scene.rotateCameraY(90)
                scene.idle(20)
                scene.world.replaceBlocks([6, 2, 4], Block.id("rimcraft:steel_import_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.EAST), true)
                scene.idle(20)
                scene.rotateCameraY(-90)
                scene.idle(20)
