Ponder.registry(event => {
  ...
  .scene(
    ...
    (builder, util) => {
      ...
      scene.world.replaceBlocks([5, 1, 3], Block.id("rimcraft:andesite_export_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.NORTH), true)
      scene.world.replaceBlocks([3, 1, 3], Block.id("rimcraft:andesite_import_bus").blockState.trySetValue($BlockStateProperties.FACING, Direction.NORTH), true)
      scene.world.replaceBlocks([4, 5, 3], Block.id("rimcraft:create_in").blockState.trySetValue($BlockStateProperties.FACING, Direction.NORTH), true)
      scene.idle(40)
      scene.idle(40)
